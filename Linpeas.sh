...
if echo $CHECKS | grep -q ProCronSrvcsTmrsSocks || echo $CHECKS | grep -q IntFiles || echo $CHECKS | grep -q SofI; then
  ...
  FIND_DIR_APPLICATIONS=`eval_bckgrd "find /applications -type d -name \"neo4j\" -o -name \".cloudflared\" -o -name \".bluemix\" -o -name \"bind\" -o -name \"sites-enabled\" -o -name \"seeddms*\" -o -name \"mysql\" -o -name \".vnc\" -o -name \".svn\" -o -name \"cacti\" -o -name \".irssi\" -o -name \"filezilla\" -o -name \"keyrings\" -o -name \"ldap\" -o -name \"logstash\" -o -name \"couchdb\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_BIN=`eval_bckgrd "find /bin -type d -name \"neo4j\" -o -name \".cloudflared\" -o -name \".bluemix\" -o -name \"bind\" -o -name \"sites-enabled\" -o -name \"seeddms*\" -o -name \"mysql\" -o -name \".vnc\" -o -name \".svn\" -o -name \"cacti\" -o -name \".irssi\" -o -name \"filezilla\" -o -name \"keyrings\" -o -name \"ldap\" -o -name \"logstash\" -o -name \"couchdb\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_CACHE=`eval_bckgrd "find /.cache -type d -name \"neo4j\" -o -name \".cloudflared\" -o -name \".bluemix\" -o -name \"bind\" -o -name \"sites-enabled\" -o -name \"seeddms*\" -o -name \"mysql\" -o -name \".vnc\" -o -name \".svn\" -o -name \"cacti\" -o -name \".irssi\" -o -name \"filezilla\" -o -name \"keyrings\" -o -name \"ldap\" -o -name \"logstash\" -o -name \"couchdb\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_CDROM=`eval_bckgrd "find /cdrom -type d -name \"neo4j\" -o -name \".cloudflared\" -o -name \".bluemix\" -o -name \"bind\" -o -name \"sites-enabled\" -o -name \"seeddms*\" -o -name \"mysql\" -o -name \".vnc\" -o -name \".svn\" -o -name \"cacti\" -o -name \".irssi\" -o -name \"filezilla\" -o -name \"keyrings\" -o -name \"ldap\" -o -name \"logstash\" -o -name \"couchdb\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_ETC=`eval_bckgrd "find /etc -type d -name \"neo4j\" -o -name \".cloudflared\" -o -name \".bluemix\" -o -name \"bind\" -o -name \"sites-enabled\" -o -name \"seeddms*\" -o -name \"mysql\" -o -name \".vnc\" -o -name \".svn\" -o -name \"cacti\" -o -name \".irssi\" -o -name \"filezilla\" -o -name \"keyrings\" -o -name \"ldap\" -o -name \"logstash\" -o -name \"system.d\" -o -name \"couchdb\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_HOMESEARCH=`eval_bckgrd "find $HOMESEARCH -type d -name \"neo4j\" -o -name \".cloudflared\" -o -name \".bluemix\" -o -name \"bind\" -o -name \"sites-enabled\" -o -name \"seeddms*\" -o -name \"mysql\" -o -name \".vnc\" -o -name \".svn\" -o -name \"cacti\" -o -name \".irssi\" -o -name \"filezilla\" -o -name \"keyrings\" -o -name \"ldap\" -o -name \"logstash\" -o -name \"couchdb\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_MEDIA=`eval_bckgrd "find /media -type d -name \"neo4j\" -o -name \".cloudflared\" -o -name \".bluemix\" -o -name \"bind\" -o -name \"sites-enabled\" -o -name \"seeddms*\" -o -name \"mysql\" -o -name \".vnc\" -o -name \".svn\" -o -name \"cacti\" -o -name \".irssi\" -o -name \"filezilla\" -o -name \"keyrings\" -o -name \"ldap\" -o -name \"logstash\" -o -name \"couchdb\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_MNT=`eval_bckgrd "find /mnt -type d -name \"neo4j\" -o -name \".cloudflared\" -o -name \".bluemix\" -o -name \"bind\" -o -name \"sites-enabled\" -o -name \"seeddms*\" -o -name \"mysql\" -o -name \".vnc\" -o -name \".svn\" -o -name \"cacti\" -o -name \".irssi\" -o -name \"filezilla\" -o -name \"keyrings\" -o -name \"ldap\" -o -name \"logstash\" -o -name \"couchdb\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_OPT=`eval_bckgrd "find /opt -type d -name \"neo4j\" -o -name \".cloudflared\" -o -name \".bluemix\" -o -name \"bind\" -o -name \"sites-enabled\" -o -name \"seeddms*\" -o -name \"mysql\" -o -name \".vnc\" -o -name \".svn\" -o -name \"cacti\" -o -name \".irssi\" -o -name \"filezilla\" -o -name \"keyrings\" -o -name \"ldap\" -o -name \"logstash\" -o -name \"couchdb\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_PRIVATE=`eval_bckgrd "find /private -type d -name \"neo4j\" -o -name \".cloudflared\" -o -name \".bluemix\" -o -name \"bind\" -o -name \"sites-enabled\" -o -name \"seeddms*\" -o -name \"mysql\" -o -name \".vnc\" -o -name \".svn\" -o -name \"cacti\" -o -name \".irssi\" -o -name \"filezilla\" -o -name \"keyrings\" -o -name \"ldap\" -o -name \"logstash\" -o -name \"couchdb\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_SBIN=`eval_bckgrd "find /sbin -type d -name \"neo4j\" -o -name \".cloudflared\" -o -name \".bluemix\" -o -name \"bind\" -o -name \"sites-enabled\" -o -name \"seeddms*\" -o -name \"mysql\" -o -name \".vnc\" -o -name \".svn\" -o -name \"cacti\" -o -name \".irssi\" -o -name \"filezilla\" -o -name \"keyrings\" -o -name \"ldap\" -o -name \"logstash\" -o -name \"couchdb\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_SNAP=`eval_bckgrd "find /snap -type d -name \"neo4j\" -o -name \".cloudflared\" -o -name \".bluemix\" -o -name \"bind\" -o -name \"sites-enabled\" -o -name \"seeddms*\" -o -name \"mysql\" -o -name \".vnc\" -o -name \".svn\" -o -name \"cacti\" -o -name \".irssi\" -o -name \"filezilla\" -o -name \"keyrings\" -o -name \"ldap\" -o -name \"logstash\" -o -name \"couchdb\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_SRV=`eval_bckgrd "find /srv -type d -name \"neo4j\" -o -name \".cloudflared\" -o -name \".bluemix\" -o -name \"bind\" -o -name \"sites-enabled\" -o -name \"seeddms*\" -o -name \"mysql\" -o -name \".vnc\" -o -name \".svn\" -o -name \"cacti\" -o -name \".irssi\" -o -name \"filezilla\" -o -name \"keyrings\" -o -name \"ldap\" -o -name \"logstash\" -o -name \"couchdb\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_TMP=`eval_bckgrd "find /tmp -type d -name \"neo4j\" -o -name \".cloudflared\" -o -name \".bluemix\" -o -name \"bind\" -o -name \"sites-enabled\" -o -name \"seeddms*\" -o -name \"mysql\" -o -name \".vnc\" -o -name \".svn\" -o -name \"cacti\" -o -name \".irssi\" -o -name \"filezilla\" -o -name \"keyrings\" -o -name \"ldap\" -o -name \"logstash\" -o -name \"couchdb\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_USR=`eval_bckgrd "find /usr -type d -name \"neo4j\" -o -name \".cloudflared\" -o -name \".bluemix\" -o -name \"bind\" -o -name \"sites-enabled\" -o -name \"seeddms*\" -o -name \"mysql\" -o -name \".vnc\" -o -name \".svn\" -o -name \"cacti\" -o -name \".irssi\" -o -name \"filezilla\" -o -name \"keyrings\" -o -name \"ldap\" -o -name \"logstash\" -o -name \"couchdb\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_VAR=`eval_bckgrd "find /var -type d -name \"neo4j\" -o -name \".cloudflared\" -o -name \".bluemix\" -o -name \"bind\" -o -name \"sites-enabled\" -o -name \"seeddms*\" -o -name \"mysql\" -o -name \".vnc\" -o -name \".svn\" -o -name \"cacti\" -o -name \".irssi\" -o -name \"filezilla\" -o -name \"keyrings\" -o -name \"ldap\" -o -name \"logstash\" -o -name \"couchdb\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_APPLICATIONS=`eval_bckgrd "find /applications -name \".pypirc\" -o -name \"*vnc*.ini\" -o -name \"SAM\" -o -name \".recently-used.xbel\" -o -name \"*vnc*.txt\" -o -name \"*.gnupg\" -o -name \"redis.conf\" -o -name \"*vnc*.xml\" -o -name \"id_rsa*\" -o -name \"access_tokens.db\" -o -name \"*.pem\" -o -name \"*.keyring\" -o -name \"kadm5.acl\" -o -name \"wp-config.php\" -o -name \"database.php\" -o -name \"docker-compose.yml\" -o -name \".git\" -o -name \"unattended.xml\" -o -name \"bash.exe\" -o -name \"*.key\" -o -name \"elasticsearch.y*ml\" -o -name \"debian.cnf\" -o -name \".msmtprc\" -o -name \"Dockerfile\" -o -name \"*.rdg\" -o -name \"access_tokens.json\" -o -name \"access.log\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.der\" -o -name \"default.sav\" -o -name \"sitemanager.xml\" -o -name \".erlang.cookie\" -o -name \"vault-ssh-helper.hcl\" -o -name \"ddclient.conf\" -o -name \"kcpassword\" -o -name \"secrets.yml\" -o -name \"*.cer\" -o -name \"azureProfile.json\" -o -name \"*.swp\" -o -name \"security.sav\" -o -name \"*.p12\" -o -name \"server.xml\" -o -name \"id_dsa*\" -o -name \"tomcat-users.xml\" -o -name \"ftp.config\" -o -name \"settings.php\" -o -name \"iis6.log\" -o -name \"wcx_ftp.ini\" -o -name \"*.viminfo\" -o -name \"system.sav\" -o -name \"*.pfx\" -o -name \"docker.socket\" -o -name \"httpd.conf\" -o -name \".env\" -o -name \"filezilla.xml\" -o -name \"*.service\" -o -name \"KeePass.ini\" -o -name \"software.sav\" -o -name \"setupinfo\" -o -name \"wsl.exe\" -o -name \"authorized_keys\" -o -name \"winscp.ini\" -o -name \"my.cnf\" -o -name \"NetSetup.log\" -o -name \"backups\" -o -name \"*.pgp\" -o -name \"*vnc*.c*nf*\" -o -name \"*.gpg\" -o -name \"unattend.inf\" -o -name \"setupinfo.bak\" -o -name \"ipsec.conf\" -o -name \"passwd\" -o -name \"autologin.conf\" -o -name \"AzureRMContext.json\" -o -name \"fastcgi_params\" -o -name \"KeePass.enforced*\" -o -name \"*.csr\" -o -name \".htpasswd\" -o -name \"pagefile.sys\" -o -name \"*credential*\" -o -name \"krb5.keytab\" -o -name \"ffftp.ini\" -o -name \"known_hosts\" -o -name \"recentservers.xml\" -o -name \"scheduledtasks.xml\" -o -name \"KeePass.config*\" -o -name \"anaconda-ks.cfg\" -o -name \"credentials.db\" -o -name \"pgadmin*.db\" -o -name \"gvm-tools.conf\" -o -name \"gitlab.yml\" -o -name \"error.log\" -o -name \"authorized_hosts\" -o -name \"ConsoleHost_history.txt\" -o -name \"protecteduserkey.bin\" -o -name \"docker.sock\" -o -name \"*password*\" -o -name \"accessTokens.json\" -o -name \"autologin\" -o -name \"*.crt\" -o -name \"storage.php\" -o -name \"legacy_credentials.db\" -o -name \"TokenCache.dat\" -o -name \".gitconfig\" -o -name \"pg_hba.conf\" -o -name \"*.ovpn\" -o -name \"db.php\" -o -name \"*.kdbx\" -o -name \"https.conf\" -o -name \"drives.xml\" -o -name \"index.dat\" -o -name \"RDCMan.settings\" -o -name \"supervisord.conf\" -o -name \"config.php\" -o -name \"hostapd.conf\" -o -name \".git-credentials\" -o -name \"appcmd.exe\" -o -name \"ws_ftp.ini\" -o -name \"web*.config\" -o -name \"000-default.conf\" -o -name \".bashrc\" -o -name \"php.ini\" -o -name \"SYSTEM\" -o -name \"rsyncd.conf\" -o -name \"scclient.exe\" -o -name \".lesshst\" -o -name \"creds*\" -o -name \".github\" -o -name \".sudo_as_admin_successful\" -o -name \"cloud.cfg\" -o -name \"datasources.xml\" -o -name \"AppEvent.Evt\" -o -name \".ldaprc\" -o -name \"my.ini\" -o -name \".plan\" -o -name \"sites.ini\" -o -name \"gitlab.rm\" -o -name \"*.sqlite3\" -o -name \"*.timer\" -o -name \"hosts.equiv\" -o -name \"Ntds.dit\" -o -name \"software\" -o -name \".rhosts\" -o -name \"kibana.y*ml\" -o -name \"ftp.ini\" -o -name \"sysprep.inf\" -o -name \"rsyncd.secrets\" -o -name \".k5login\" -o -name \"mosquitto.conf\" -o -name \"https-xampp.conf\" -o -name \"*.db\" -o -name \"snmpd.conf\" -o -name \"cesi.conf\" -o -name \"*.ftpconfig\" -o -name \"*.sqlite\" -o -name \"backup\" -o -name \".*_history.*\" -o -name \"SecEvent.Evt\" -o -name \"unattend.txt\" -o -name \"printers.xml\" -o -name \"mongod*.conf\" -o -name \"*.keystore\" -o -name \"unattend.xml\" -o -name \"krb5.conf\" -o -name \"groups.xml\" -o -name \"*.jks\" -o -name \"sysprep.xml\" -o -name \"*config*.php\" -o -name \"ipsec.secrets\" -o -name \"*.socket\" -o -name \"credentials\" -o -name \".vault-token\" -o -name \".profile\" -o -name \"postgresql.conf\" -o -name \".google_authenticator\" -o -name \"ntuser.dat\" -o -name \"pgsql.conf\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_BIN=`eval_bckgrd "find /bin -name \".pypirc\" -o -name \"*vnc*.ini\" -o -name \"SAM\" -o -name \".recently-used.xbel\" -o -name \"*vnc*.txt\" -o -name \"*.gnupg\" -o -name \"redis.conf\" -o -name \"*vnc*.xml\" -o -name \"id_rsa*\" -o -name \"access_tokens.db\" -o -name \"*.pem\" -o -name \"*.keyring\" -o -name \"kadm5.acl\" -o -name \"wp-config.php\" -o -name \"database.php\" -o -name \"docker-compose.yml\" -o -name \".git\" -o -name \"unattended.xml\" -o -name \"bash.exe\" -o -name \"*.key\" -o -name \"elasticsearch.y*ml\" -o -name \"debian.cnf\" -o -name \".msmtprc\" -o -name \"Dockerfile\" -o -name \"*.rdg\" -o -name \"access_tokens.json\" -o -name \"access.log\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.der\" -o -name \"default.sav\" -o -name \"sitemanager.xml\" -o -name \".erlang.cookie\" -o -name \"vault-ssh-helper.hcl\" -o -name \"ddclient.conf\" -o -name \"kcpassword\" -o -name \"secrets.yml\" -o -name \"*.cer\" -o -name \"azureProfile.json\" -o -name \"*.swp\" -o -name \"security.sav\" -o -name \"*.p12\" -o -name \"server.xml\" -o -name \"id_dsa*\" -o -name \"tomcat-users.xml\" -o -name \"ftp.config\" -o -name \"settings.php\" -o -name \"iis6.log\" -o -name \"wcx_ftp.ini\" -o -name \"*.viminfo\" -o -name \"system.sav\" -o -name \"*.pfx\" -o -name \"docker.socket\" -o -name \"httpd.conf\" -o -name \".env\" -o -name \"filezilla.xml\" -o -name \"*.service\" -o -name \"KeePass.ini\" -o -name \"software.sav\" -o -name \"setupinfo\" -o -name \"wsl.exe\" -o -name \"authorized_keys\" -o -name \"winscp.ini\" -o -name \"my.cnf\" -o -name \"NetSetup.log\" -o -name \"backups\" -o -name \"*.pgp\" -o -name \"*vnc*.c*nf*\" -o -name \"*.gpg\" -o -name \"unattend.inf\" -o -name \"setupinfo.bak\" -o -name \"ipsec.conf\" -o -name \"passwd\" -o -name \"autologin.conf\" -o -name \"AzureRMContext.json\" -o -name \"fastcgi_params\" -o -name \"KeePass.enforced*\" -o -name \"*.csr\" -o -name \".htpasswd\" -o -name \"pagefile.sys\" -o -name \"*credential*\" -o -name \"krb5.keytab\" -o -name \"ffftp.ini\" -o -name \"known_hosts\" -o -name \"recentservers.xml\" -o -name \"scheduledtasks.xml\" -o -name \"KeePass.config*\" -o -name \"anaconda-ks.cfg\" -o -name \"credentials.db\" -o -name \"pgadmin*.db\" -o -name \"gvm-tools.conf\" -o -name \"gitlab.yml\" -o -name \"error.log\" -o -name \"authorized_hosts\" -o -name \"ConsoleHost_history.txt\" -o -name \"protecteduserkey.bin\" -o -name \"docker.sock\" -o -name \"*password*\" -o -name \"accessTokens.json\" -o -name \"autologin\" -o -name \"*.crt\" -o -name \"storage.php\" -o -name \"legacy_credentials.db\" -o -name \"TokenCache.dat\" -o -name \".gitconfig\" -o -name \"pg_hba.conf\" -o -name \"*.ovpn\" -o -name \"db.php\" -o -name \"*.kdbx\" -o -name \"https.conf\" -o -name \"drives.xml\" -o -name \"index.dat\" -o -name \"RDCMan.settings\" -o -name \"supervisord.conf\" -o -name \"config.php\" -o -name \"hostapd.conf\" -o -name \".git-credentials\" -o -name \"appcmd.exe\" -o -name \"ws_ftp.ini\" -o -name \"web*.config\" -o -name \"000-default.conf\" -o -name \".bashrc\" -o -name \"php.ini\" -o -name \"SYSTEM\" -o -name \"rsyncd.conf\" -o -name \"scclient.exe\" -o -name \".lesshst\" -o -name \"creds*\" -o -name \".github\" -o -name \".sudo_as_admin_successful\" -o -name \"cloud.cfg\" -o -name \"datasources.xml\" -o -name \"AppEvent.Evt\" -o -name \".ldaprc\" -o -name \"my.ini\" -o -name \".plan\" -o -name \"sites.ini\" -o -name \"gitlab.rm\" -o -name \"*.sqlite3\" -o -name \"*.timer\" -o -name \"hosts.equiv\" -o -name \"Ntds.dit\" -o -name \"software\" -o -name \".rhosts\" -o -name \"kibana.y*ml\" -o -name \"ftp.ini\" -o -name \"sysprep.inf\" -o -name \"rsyncd.secrets\" -o -name \".k5login\" -o -name \"mosquitto.conf\" -o -name \"https-xampp.conf\" -o -name \"*.db\" -o -name \"snmpd.conf\" -o -name \"cesi.conf\" -o -name \"*.ftpconfig\" -o -name \"*.sqlite\" -o -name \"backup\" -o -name \".*_history.*\" -o -name \"SecEvent.Evt\" -o -name \"unattend.txt\" -o -name \"printers.xml\" -o -name \"mongod*.conf\" -o -name \"*.keystore\" -o -name \"unattend.xml\" -o -name \"krb5.conf\" -o -name \"groups.xml\" -o -name \"*.jks\" -o -name \"sysprep.xml\" -o -name \"*config*.php\" -o -name \"ipsec.secrets\" -o -name \"*.socket\" -o -name \"credentials\" -o -name \".vault-token\" -o -name \".profile\" -o -name \"postgresql.conf\" -o -name \".google_authenticator\" -o -name \"ntuser.dat\" -o -name \"pgsql.conf\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_CACHE=`eval_bckgrd "find /.cache -name \".pypirc\" -o -name \"*vnc*.ini\" -o -name \"SAM\" -o -name \".recently-used.xbel\" -o -name \"*vnc*.txt\" -o -name \"*.gnupg\" -o -name \"redis.conf\" -o -name \"*vnc*.xml\" -o -name \"id_rsa*\" -o -name \"access_tokens.db\" -o -name \"*.pem\" -o -name \"*.keyring\" -o -name \"kadm5.acl\" -o -name \"wp-config.php\" -o -name \"database.php\" -o -name \"docker-compose.yml\" -o -name \".git\" -o -name \"unattended.xml\" -o -name \"bash.exe\" -o -name \"*.key\" -o -name \"elasticsearch.y*ml\" -o -name \"debian.cnf\" -o -name \".msmtprc\" -o -name \"Dockerfile\" -o -name \"*.rdg\" -o -name \"access_tokens.json\" -o -name \"access.log\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.der\" -o -name \"default.sav\" -o -name \"sitemanager.xml\" -o -name \".erlang.cookie\" -o -name \"vault-ssh-helper.hcl\" -o -name \"ddclient.conf\" -o -name \"kcpassword\" -o -name \"secrets.yml\" -o -name \"*.cer\" -o -name \"azureProfile.json\" -o -name \"*.swp\" -o -name \"security.sav\" -o -name \"*.p12\" -o -name \"server.xml\" -o -name \"id_dsa*\" -o -name \"tomcat-users.xml\" -o -name \"ftp.config\" -o -name \"settings.php\" -o -name \"iis6.log\" -o -name \"wcx_ftp.ini\" -o -name \"*.viminfo\" -o -name \"system.sav\" -o -name \"*.pfx\" -o -name \"docker.socket\" -o -name \"httpd.conf\" -o -name \".env\" -o -name \"filezilla.xml\" -o -name \"*.service\" -o -name \"KeePass.ini\" -o -name \"software.sav\" -o -name \"setupinfo\" -o -name \"wsl.exe\" -o -name \"authorized_keys\" -o -name \"winscp.ini\" -o -name \"my.cnf\" -o -name \"NetSetup.log\" -o -name \"backups\" -o -name \"*.pgp\" -o -name \"*vnc*.c*nf*\" -o -name \"*.gpg\" -o -name \"unattend.inf\" -o -name \"setupinfo.bak\" -o -name \"ipsec.conf\" -o -name \"passwd\" -o -name \"autologin.conf\" -o -name \"AzureRMContext.json\" -o -name \"fastcgi_params\" -o -name \"KeePass.enforced*\" -o -name \"*.csr\" -o -name \".htpasswd\" -o -name \"pagefile.sys\" -o -name \"*credential*\" -o -name \"krb5.keytab\" -o -name \"ffftp.ini\" -o -name \"known_hosts\" -o -name \"recentservers.xml\" -o -name \"scheduledtasks.xml\" -o -name \"KeePass.config*\" -o -name \"anaconda-ks.cfg\" -o -name \"credentials.db\" -o -name \"pgadmin*.db\" -o -name \"gvm-tools.conf\" -o -name \"gitlab.yml\" -o -name \"error.log\" -o -name \"authorized_hosts\" -o -name \"ConsoleHost_history.txt\" -o -name \"protecteduserkey.bin\" -o -name \"docker.sock\" -o -name \"*password*\" -o -name \"accessTokens.json\" -o -name \"autologin\" -o -name \"*.crt\" -o -name \"storage.php\" -o -name \"legacy_credentials.db\" -o -name \"TokenCache.dat\" -o -name \".gitconfig\" -o -name \"pg_hba.conf\" -o -name \"*.ovpn\" -o -name \"db.php\" -o -name \"*.kdbx\" -o -name \"https.conf\" -o -name \"drives.xml\" -o -name \"index.dat\" -o -name \"RDCMan.settings\" -o -name \"supervisord.conf\" -o -name \"config.php\" -o -name \"hostapd.conf\" -o -name \".git-credentials\" -o -name \"appcmd.exe\" -o -name \"ws_ftp.ini\" -o -name \"web*.config\" -o -name \"000-default.conf\" -o -name \".bashrc\" -o -name \"php.ini\" -o -name \"SYSTEM\" -o -name \"rsyncd.conf\" -o -name \"scclient.exe\" -o -name \".lesshst\" -o -name \"creds*\" -o -name \".github\" -o -name \".sudo_as_admin_successful\" -o -name \"cloud.cfg\" -o -name \"datasources.xml\" -o -name \"AppEvent.Evt\" -o -name \".ldaprc\" -o -name \"my.ini\" -o -name \".plan\" -o -name \"sites.ini\" -o -name \"gitlab.rm\" -o -name \"*.sqlite3\" -o -name \"*.timer\" -o -name \"hosts.equiv\" -o -name \"Ntds.dit\" -o -name \"software\" -o -name \".rhosts\" -o -name \"kibana.y*ml\" -o -name \"ftp.ini\" -o -name \"sysprep.inf\" -o -name \"rsyncd.secrets\" -o -name \".k5login\" -o -name \"mosquitto.conf\" -o -name \"https-xampp.conf\" -o -name \"*.db\" -o -name \"snmpd.conf\" -o -name \"cesi.conf\" -o -name \"*.ftpconfig\" -o -name \"*.sqlite\" -o -name \"backup\" -o -name \".*_history.*\" -o -name \"SecEvent.Evt\" -o -name \"unattend.txt\" -o -name \"printers.xml\" -o -name \"mongod*.conf\" -o -name \"*.keystore\" -o -name \"unattend.xml\" -o -name \"krb5.conf\" -o -name \"groups.xml\" -o -name \"*.jks\" -o -name \"sysprep.xml\" -o -name \"*config*.php\" -o -name \"ipsec.secrets\" -o -name \"*.socket\" -o -name \"credentials\" -o -name \".vault-token\" -o -name \".profile\" -o -name \"postgresql.conf\" -o -name \".google_authenticator\" -o -name \"ntuser.dat\" -o -name \"pgsql.conf\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_CDROM=`eval_bckgrd "find /cdrom -name \".pypirc\" -o -name \"*vnc*.ini\" -o -name \"SAM\" -o -name \".recently-used.xbel\" -o -name \"*vnc*.txt\" -o -name \"*.gnupg\" -o -name \"redis.conf\" -o -name \"*vnc*.xml\" -o -name \"id_rsa*\" -o -name \"access_tokens.db\" -o -name \"*.pem\" -o -name \"*.keyring\" -o -name \"kadm5.acl\" -o -name \"wp-config.php\" -o -name \"database.php\" -o -name \"docker-compose.yml\" -o -name \".git\" -o -name \"unattended.xml\" -o -name \"bash.exe\" -o -name \"*.key\" -o -name \"elasticsearch.y*ml\" -o -name \"debian.cnf\" -o -name \".msmtprc\" -o -name \"Dockerfile\" -o -name \"*.rdg\" -o -name \"access_tokens.json\" -o -name \"access.log\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.der\" -o -name \"default.sav\" -o -name \"sitemanager.xml\" -o -name \".erlang.cookie\" -o -name \"vault-ssh-helper.hcl\" -o -name \"ddclient.conf\" -o -name \"kcpassword\" -o -name \"secrets.yml\" -o -name \"*.cer\" -o -name \"azureProfile.json\" -o -name \"*.swp\" -o -name \"security.sav\" -o -name \"*.p12\" -o -name \"server.xml\" -o -name \"id_dsa*\" -o -name \"tomcat-users.xml\" -o -name \"ftp.config\" -o -name \"settings.php\" -o -name \"iis6.log\" -o -name \"wcx_ftp.ini\" -o -name \"*.viminfo\" -o -name \"system.sav\" -o -name \"*.pfx\" -o -name \"docker.socket\" -o -name \"httpd.conf\" -o -name \".env\" -o -name \"filezilla.xml\" -o -name \"*.service\" -o -name \"KeePass.ini\" -o -name \"software.sav\" -o -name \"setupinfo\" -o -name \"wsl.exe\" -o -name \"authorized_keys\" -o -name \"winscp.ini\" -o -name \"my.cnf\" -o -name \"NetSetup.log\" -o -name \"backups\" -o -name \"*.pgp\" -o -name \"*vnc*.c*nf*\" -o -name \"*.gpg\" -o -name \"unattend.inf\" -o -name \"setupinfo.bak\" -o -name \"ipsec.conf\" -o -name \"passwd\" -o -name \"autologin.conf\" -o -name \"AzureRMContext.json\" -o -name \"fastcgi_params\" -o -name \"KeePass.enforced*\" -o -name \"*.csr\" -o -name \".htpasswd\" -o -name \"pagefile.sys\" -o -name \"*credential*\" -o -name \"krb5.keytab\" -o -name \"ffftp.ini\" -o -name \"known_hosts\" -o -name \"recentservers.xml\" -o -name \"scheduledtasks.xml\" -o -name \"KeePass.config*\" -o -name \"anaconda-ks.cfg\" -o -name \"credentials.db\" -o -name \"pgadmin*.db\" -o -name \"gvm-tools.conf\" -o -name \"gitlab.yml\" -o -name \"error.log\" -o -name \"authorized_hosts\" -o -name \"ConsoleHost_history.txt\" -o -name \"protecteduserkey.bin\" -o -name \"docker.sock\" -o -name \"*password*\" -o -name \"accessTokens.json\" -o -name \"autologin\" -o -name \"*.crt\" -o -name \"storage.php\" -o -name \"legacy_credentials.db\" -o -name \"TokenCache.dat\" -o -name \".gitconfig\" -o -name \"pg_hba.conf\" -o -name \"*.ovpn\" -o -name \"db.php\" -o -name \"*.kdbx\" -o -name \"https.conf\" -o -name \"drives.xml\" -o -name \"index.dat\" -o -name \"RDCMan.settings\" -o -name \"supervisord.conf\" -o -name \"config.php\" -o -name \"hostapd.conf\" -o -name \".git-credentials\" -o -name \"appcmd.exe\" -o -name \"ws_ftp.ini\" -o -name \"web*.config\" -o -name \"000-default.conf\" -o -name \".bashrc\" -o -name \"php.ini\" -o -name \"SYSTEM\" -o -name \"rsyncd.conf\" -o -name \"scclient.exe\" -o -name \".lesshst\" -o -name \"creds*\" -o -name \".github\" -o -name \".sudo_as_admin_successful\" -o -name \"cloud.cfg\" -o -name \"datasources.xml\" -o -name \"AppEvent.Evt\" -o -name \".ldaprc\" -o -name \"my.ini\" -o -name \".plan\" -o -name \"sites.ini\" -o -name \"gitlab.rm\" -o -name \"*.sqlite3\" -o -name \"*.timer\" -o -name \"hosts.equiv\" -o -name \"Ntds.dit\" -o -name \"software\" -o -name \".rhosts\" -o -name \"kibana.y*ml\" -o -name \"ftp.ini\" -o -name \"sysprep.inf\" -o -name \"rsyncd.secrets\" -o -name \".k5login\" -o -name \"mosquitto.conf\" -o -name \"https-xampp.conf\" -o -name \"*.db\" -o -name \"snmpd.conf\" -o -name \"cesi.conf\" -o -name \"*.ftpconfig\" -o -name \"*.sqlite\" -o -name \"backup\" -o -name \".*_history.*\" -o -name \"SecEvent.Evt\" -o -name \"unattend.txt\" -o -name \"printers.xml\" -o -name \"mongod*.conf\" -o -name \"*.keystore\" -o -name \"unattend.xml\" -o -name \"krb5.conf\" -o -name \"groups.xml\" -o -name \"*.jks\" -o -name \"sysprep.xml\" -o -name \"*config*.php\" -o -name \"ipsec.secrets\" -o -name \"*.socket\" -o -name \"credentials\" -o -name \".vault-token\" -o -name \".profile\" -o -name \"postgresql.conf\" -o -name \".google_authenticator\" -o -name \"ntuser.dat\" -o -name \"pgsql.conf\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_ETC=`eval_bckgrd "find /etc -name \".pypirc\" -o -name \"*vnc*.ini\" -o -name \"SAM\" -o -name \".recently-used.xbel\" -o -name \"*vnc*.txt\" -o -name \"*.gnupg\" -o -name \"redis.conf\" -o -name \"*vnc*.xml\" -o -name \"id_rsa*\" -o -name \"access_tokens.db\" -o -name \"*.pem\" -o -name \"*.keyring\" -o -name \"kadm5.acl\" -o -name \"wp-config.php\" -o -name \"database.php\" -o -name \"docker-compose.yml\" -o -name \".git\" -o -name \"unattended.xml\" -o -name \"bash.exe\" -o -name \"*.key\" -o -name \"elasticsearch.y*ml\" -o -name \"debian.cnf\" -o -name \".msmtprc\" -o -name \"Dockerfile\" -o -name \"*.rdg\" -o -name \"access_tokens.json\" -o -name \"access.log\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.der\" -o -name \"default.sav\" -o -name \"sitemanager.xml\" -o -name \".erlang.cookie\" -o -name \"vault-ssh-helper.hcl\" -o -name \"ddclient.conf\" -o -name \"kcpassword\" -o -name \"secrets.yml\" -o -name \"*.cer\" -o -name \"azureProfile.json\" -o -name \"*.swp\" -o -name \"security.sav\" -o -name \"*.p12\" -o -name \"server.xml\" -o -name \"id_dsa*\" -o -name \"tomcat-users.xml\" -o -name \"ftp.config\" -o -name \"settings.php\" -o -name \"iis6.log\" -o -name \"wcx_ftp.ini\" -o -name \"*.viminfo\" -o -name \"system.sav\" -o -name \"*.pfx\" -o -name \"docker.socket\" -o -name \"httpd.conf\" -o -name \".env\" -o -name \"filezilla.xml\" -o -name \"*.service\" -o -name \"KeePass.ini\" -o -name \"software.sav\" -o -name \"setupinfo\" -o -name \"wsl.exe\" -o -name \"authorized_keys\" -o -name \"winscp.ini\" -o -name \"my.cnf\" -o -name \"NetSetup.log\" -o -name \"backups\" -o -name \"*.pgp\" -o -name \"*vnc*.c*nf*\" -o -name \"*.gpg\" -o -name \"unattend.inf\" -o -name \"setupinfo.bak\" -o -name \"ipsec.conf\" -o -name \"passwd\" -o -name \"autologin.conf\" -o -name \"AzureRMContext.json\" -o -name \"fastcgi_params\" -o -name \"KeePass.enforced*\" -o -name \"*.csr\" -o -name \".htpasswd\" -o -name \"pagefile.sys\" -o -name \"*credential*\" -o -name \"krb5.keytab\" -o -name \"ffftp.ini\" -o -name \"known_hosts\" -o -name \"recentservers.xml\" -o -name \"scheduledtasks.xml\" -o -name \"KeePass.config*\" -o -name \"anaconda-ks.cfg\" -o -name \"credentials.db\" -o -name \"pgadmin*.db\" -o -name \"gvm-tools.conf\" -o -name \"gitlab.yml\" -o -name \"error.log\" -o -name \"authorized_hosts\" -o -name \"ConsoleHost_history.txt\" -o -name \"protecteduserkey.bin\" -o -name \"docker.sock\" -o -name \"*password*\" -o -name \"accessTokens.json\" -o -name \"autologin\" -o -name \"*.crt\" -o -name \"storage.php\" -o -name \"legacy_credentials.db\" -o -name \"*knockd*\" -o -name \"TokenCache.dat\" -o -name \".gitconfig\" -o -name \"pg_hba.conf\" -o -name \"*.ovpn\" -o -name \"db.php\" -o -name \"*.kdbx\" -o -name \"https.conf\" -o -name \"drives.xml\" -o -name \"index.dat\" -o -name \"RDCMan.settings\" -o -name \"supervisord.conf\" -o -name \"config.php\" -o -name \"hostapd.conf\" -o -name \".git-credentials\" -o -name \"appcmd.exe\" -o -name \"ws_ftp.ini\" -o -name \"web*.config\" -o -name \"000-default.conf\" -o -name \".bashrc\" -o -name \"php.ini\" -o -name \"SYSTEM\" -o -name \"rsyncd.conf\" -o -name \"scclient.exe\" -o -name \".lesshst\" -o -name \"creds*\" -o -name \".github\" -o -name \".sudo_as_admin_successful\" -o -name \"cloud.cfg\" -o -name \"datasources.xml\" -o -name \"AppEvent.Evt\" -o -name \".ldaprc\" -o -name \"my.ini\" -o -name \".plan\" -o -name \"sites.ini\" -o -name \"gitlab.rm\" -o -name \"*.sqlite3\" -o -name \"*.timer\" -o -name \"hosts.equiv\" -o -name \"Ntds.dit\" -o -name \"software\" -o -name \".rhosts\" -o -name \"kibana.y*ml\" -o -name \"ftp.ini\" -o -name \"sysprep.inf\" -o -name \"rsyncd.secrets\" -o -name \".k5login\" -o -name \"mosquitto.conf\" -o -name \"https-xampp.conf\" -o -name \"*.db\" -o -name \"snmpd.conf\" -o -name \"cesi.conf\" -o -name \"*.ftpconfig\" -o -name \"*.sqlite\" -o -name \"backup\" -o -name \".*_history.*\" -o -name \"SecEvent.Evt\" -o -name \"unattend.txt\" -o -name \"printers.xml\" -o -name \"mongod*.conf\" -o -name \"*.keystore\" -o -name \"unattend.xml\" -o -name \"krb5.conf\" -o -name \"groups.xml\" -o -name \"*.jks\" -o -name \"sysprep.xml\" -o -name \"*config*.php\" -o -name \"ipsec.secrets\" -o -name \"*.socket\" -o -name \"credentials\" -o -name \".vault-token\" -o -name \".profile\" -o -name \"postgresql.conf\" -o -name \".google_authenticator\" -o -name \"ntuser.dat\" -o -name \"pgsql.conf\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_HOMESEARCH=`eval_bckgrd "find $HOMESEARCH -name \".pypirc\" -o -name \"*vnc*.ini\" -o -name \"SAM\" -o -name \".recently-used.xbel\" -o -name \"*vnc*.txt\" -o -name \"*.gnupg\" -o -name \"redis.conf\" -o -name \"*vnc*.xml\" -o -name \"id_rsa*\" -o -name \"access_tokens.db\" -o -name \"*.pem\" -o -name \"*.keyring\" -o -name \"kadm5.acl\" -o -name \"wp-config.php\" -o -name \"database.php\" -o -name \"docker-compose.yml\" -o -name \".git\" -o -name \"unattended.xml\" -o -name \"bash.exe\" -o -name \"*.key\" -o -name \"elasticsearch.y*ml\" -o -name \"debian.cnf\" -o -name \".msmtprc\" -o -name \"Dockerfile\" -o -name \"*.rdg\" -o -name \"access_tokens.json\" -o -name \"access.log\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.der\" -o -name \"default.sav\" -o -name \"sitemanager.xml\" -o -name \".erlang.cookie\" -o -name \"vault-ssh-helper.hcl\" -o -name \"ddclient.conf\" -o -name \"kcpassword\" -o -name \"secrets.yml\" -o -name \"*.cer\" -o -name \"azureProfile.json\" -o -name \"*.swp\" -o -name \"security.sav\" -o -name \"*.p12\" -o -name \"server.xml\" -o -name \"id_dsa*\" -o -name \"tomcat-users.xml\" -o -name \"ftp.config\" -o -name \"settings.php\" -o -name \"iis6.log\" -o -name \"wcx_ftp.ini\" -o -name \"*.viminfo\" -o -name \"system.sav\" -o -name \"*.pfx\" -o -name \"docker.socket\" -o -name \"httpd.conf\" -o -name \".env\" -o -name \"filezilla.xml\" -o -name \"*.service\" -o -name \"KeePass.ini\" -o -name \"software.sav\" -o -name \"setupinfo\" -o -name \"wsl.exe\" -o -name \"authorized_keys\" -o -name \"winscp.ini\" -o -name \"my.cnf\" -o -name \"NetSetup.log\" -o -name \"backups\" -o -name \"*.pgp\" -o -name \"*vnc*.c*nf*\" -o -name \"*.gpg\" -o -name \"unattend.inf\" -o -name \"setupinfo.bak\" -o -name \"ipsec.conf\" -o -name \"passwd\" -o -name \"autologin.conf\" -o -name \"AzureRMContext.json\" -o -name \"fastcgi_params\" -o -name \"KeePass.enforced*\" -o -name \"*.csr\" -o -name \".htpasswd\" -o -name \"pagefile.sys\" -o -name \"*credential*\" -o -name \"krb5.keytab\" -o -name \"ffftp.ini\" -o -name \"known_hosts\" -o -name \"recentservers.xml\" -o -name \"scheduledtasks.xml\" -o -name \"KeePass.config*\" -o -name \"anaconda-ks.cfg\" -o -name \"credentials.db\" -o -name \"pgadmin*.db\" -o -name \"gvm-tools.conf\" -o -name \"gitlab.yml\" -o -name \"error.log\" -o -name \"authorized_hosts\" -o -name \"ConsoleHost_history.txt\" -o -name \"protecteduserkey.bin\" -o -name \"docker.sock\" -o -name \"*password*\" -o -name \"accessTokens.json\" -o -name \"autologin\" -o -name \"*.crt\" -o -name \"storage.php\" -o -name \"legacy_credentials.db\" -o -name \"TokenCache.dat\" -o -name \".gitconfig\" -o -name \"pg_hba.conf\" -o -name \"*.ovpn\" -o -name \"db.php\" -o -name \"*.kdbx\" -o -name \"https.conf\" -o -name \"drives.xml\" -o -name \"index.dat\" -o -name \"RDCMan.settings\" -o -name \"supervisord.conf\" -o -name \"config.php\" -o -name \"hostapd.conf\" -o -name \".git-credentials\" -o -name \"appcmd.exe\" -o -name \"ws_ftp.ini\" -o -name \"web*.config\" -o -name \"000-default.conf\" -o -name \".bashrc\" -o -name \"php.ini\" -o -name \"SYSTEM\" -o -name \"rsyncd.conf\" -o -name \"scclient.exe\" -o -name \".lesshst\" -o -name \"creds*\" -o -name \".github\" -o -name \".sudo_as_admin_successful\" -o -name \"cloud.cfg\" -o -name \"datasources.xml\" -o -name \"AppEvent.Evt\" -o -name \".ldaprc\" -o -name \"my.ini\" -o -name \".plan\" -o -name \"sites.ini\" -o -name \"gitlab.rm\" -o -name \"*.sqlite3\" -o -name \"*.timer\" -o -name \"hosts.equiv\" -o -name \"Ntds.dit\" -o -name \"software\" -o -name \".rhosts\" -o -name \"kibana.y*ml\" -o -name \"ftp.ini\" -o -name \"sysprep.inf\" -o -name \"rsyncd.secrets\" -o -name \".k5login\" -o -name \"mosquitto.conf\" -o -name \"https-xampp.conf\" -o -name \"*.db\" -o -name \"snmpd.conf\" -o -name \"cesi.conf\" -o -name \"*.ftpconfig\" -o -name \"*.sqlite\" -o -name \"backup\" -o -name \".*_history.*\" -o -name \"SecEvent.Evt\" -o -name \"unattend.txt\" -o -name \"ssh*config\" -o -name \"printers.xml\" -o -name \"mongod*.conf\" -o -name \"*.keystore\" -o -name \"unattend.xml\" -o -name \"krb5.conf\" -o -name \"groups.xml\" -o -name \"*.jks\" -o -name \"sysprep.xml\" -o -name \"*config*.php\" -o -name \"ipsec.secrets\" -o -name \"*.socket\" -o -name \"credentials\" -o -name \".vault-token\" -o -name \".profile\" -o -name \"postgresql.conf\" -o -name \".google_authenticator\" -o -name \"ntuser.dat\" -o -name \"pgsql.conf\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  FIND_MEDIA=`eval_bckgrd "find /media -name \".pypirc\" -o -name \"*vnc*.ini\" -o -name \"SAM\" -o -name \".recently-used.xbel\" -o -name \"*vnc*.txt\" -o -name \"*.gnupg\" -o -name \"redis.conf\" -o -name \"*vnc*.xml\" -o -name \"id_rsa*\" -o -name \"access_tokens.db\" -o -name \"*.pem\" -o -name \"*.keyring\" -o -name \"kadm5.acl\" -o -name \"wp-config.php\" -o -name \"database.php\" -o -name \"docker-compose.yml\" -o -name \".git\" -o -name \"unattended.xml\" -o -name \"bash.exe\" -o -name \"*.key\" -o -name \"elasticsearch.y*ml\" -o -name \"debian.cnf\" -o -name \".msmtprc\" -o -name \"Dockerfile\" -o -name \"*.rdg\" -o -name \"access_tokens.json\" -o -name \"access.log\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.der\" -o -name \"default.sav\" -o -name \"sitemanager.xml\" -o -name \".erlang.cookie\" -o -name \"vault-ssh-helper.hcl\" -o -name \"ddclient.conf\" -o -name \"kcpassword\" -o -name \"secrets.yml\" -o -name \"*.cer\" -o -name \"azureProfile.json\" -o -name \"*.swp\" -o -name \"security.sav\" -o -name \"*.p12\" -o -name \"server.xml\" -o -name \"id_dsa*\" -o -name \"tomcat-users.xml\" -o -name \"ftp.config\" -o -name \"settings.php\" -o -name \"iis6.log\" -o -name \"wcx_ftp.ini\" -o -name \"*.viminfo\" -o -name \"system.sav\" -o -name \"*.pfx\" -o -name \"docker.socket\" -o -name \"httpd.conf\" -o -name \".env\" -o -name \"filezilla.xml\" -o -name \"*.service\" -o -name \"KeePass.ini\" -o -name \"software.sav\" -o -name \"setupinfo\" -o -name \"wsl.exe\" -o -name \"authorized_keys\" -o -name \"winscp.ini\" -o -name \"my.cnf\" -o -name \"NetSetup.log\" -o -name \"backups\" -o -name \"*.pgp\" -o -name \"*vnc*.c*nf*\" -o -name \"*.gpg\" -o -name \"unattend.inf\" -o -name \"setupinfo.bak\" -o -name \"ipsec.conf\" -o -name \"passwd\" -o -name \"autologin.conf\" -o -name \"AzureRMContext.json\" -o -name \"fastcgi_params\" -o -name \"KeePass.enforced*\" -o -name \"*.csr\" -o -name \".htpasswd\" -o -name \"pagefile.sys\" -o -name \"*credential*\" -o -name \"krb5.keytab\" -o -name \"ffftp.ini\" -o -name \"known_hosts\" -o -name \"recentservers.xml\" -o -name \"scheduledtasks.xml\" -o -name \"KeePass.config*\" -o -name \"anaconda-ks.cfg\" -o -name \"credentials.db\" -o -name \"pgadmin*.db\" -o -name \"gvm-tools.conf\" -o -name \"gitlab.yml\" -o -name \"error.log\" -o -name \"authorized_hosts\" -o -name \"ConsoleHost_history.txt\" -o -name \"protecteduserkey.bin\" -o -name \"docker.sock\" -o -name \"*password*\" -o -name \"accessTokens.json\" -o -name \"autologin\" -o -name \"*.crt\" -o -name \"storage.php\" -o -name \"legacy_credentials.db\" -o -name \"TokenCache.dat\" -o -name \".gitconfig\" -o -name \"pg_hba.conf\" -o -name \"*.ovpn\" -o -name \"db.php\" -o -name \"*.kdbx\" -o -name \"https.conf\" -o -name \"drives.xml\" -o -name \"index.dat\" -o -name \"RDCMan.settings\" -o -name \"supervisord.conf\" -o -name \"config.php\" -o -name \"hostapd.conf\" -o -name \".git-credentials\" -o -name \"appcmd.exe\" -o -name \"ws_ftp.ini\" -o -name \"web*.config\" -o -name \"000-default.conf\" -o -name \".bashrc\" -o -name \"php.ini\" -o -name \"SYSTEM\" -o -name \"rsyncd.conf\" -o -name \"scclient.exe\" -o -name \".lesshst\" -o -name \"creds*\" -o -name \".github\" -o -name \".sudo_as_admin_successful\" -o -name \"cloud.cfg\" -o -name \"datasources.xml\" -o -name \"AppEvent.Evt\" -o -name \".ldaprc\" -o -name \"my.ini\" -o -name \".plan\" -o -name \"sites.ini\" -o -name \"gitlab.rm\" -o -name \"*.sqlite3\" -o -name \"*.timer\" -o -name \"hosts.equiv\" -o -name \"Ntds.dit\" -o -name \"software\" -o -name \".rhosts\" -o -name \"kibana.y*ml\" -o -name \"ftp.ini\" -o -name \"sysprep.inf\" -o -name \"rsyncd.secrets\" -o -name \".k5login\" -o -name \"mosquitto.conf\" -o -name \"https-xampp.conf\" -o -name \"*.db\" -o -name \"snmpd.conf\" -o -name \"cesi.conf\" -o -name \"*.ftpconfig\" -o -name \"*.sqlite\" -o -name \"backup\" -o -name \".*_history.*\" -o -name \"SecEvent.Evt\" -o -name \"unattend.txt\" -o -name \"printers.xml\" -o -name \"mongod*.conf\" -o -name \"*.keystore\" -o -name \"unattend.xml\" -o -name \"krb5.conf\" -o -name \"groups.xml\" -o -name \"*.jks\" -o -name \"sysprep.xml\" -o -name \"*config*.php\" -o -name \"ipsec.secrets\" -o -name \"*.socket\" -o -name \"credentials\" -o -name \".vault-token\" -o -name \".profile\" -o -name \"postgresql.conf\" -o -name \".google_authenticator\" -o -name \"ntuser.dat\" -o -name \"pgsql.conf\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_MNT=`eval_bckgrd "find /mnt -name \".pypirc\" -o -name \"*vnc*.ini\" -o -name \"SAM\" -o -name \".recently-used.xbel\" -o -name \"*vnc*.txt\" -o -name \"*.gnupg\" -o -name \"redis.conf\" -o -name \"*vnc*.xml\" -o -name \"id_rsa*\" -o -name \"access_tokens.db\" -o -name \"*.pem\" -o -name \"*.keyring\" -o -name \"kadm5.acl\" -o -name \"wp-config.php\" -o -name \"database.php\" -o -name \"docker-compose.yml\" -o -name \".git\" -o -name \"unattended.xml\" -o -name \"bash.exe\" -o -name \"*.key\" -o -name \"elasticsearch.y*ml\" -o -name \"debian.cnf\" -o -name \".msmtprc\" -o -name \"Dockerfile\" -o -name \"*.rdg\" -o -name \"access_tokens.json\" -o -name \"access.log\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.der\" -o -name \"default.sav\" -o -name \"sitemanager.xml\" -o -name \".erlang.cookie\" -o -name \"vault-ssh-helper.hcl\" -o -name \"ddclient.conf\" -o -name \"kcpassword\" -o -name \"secrets.yml\" -o -name \"*.cer\" -o -name \"azureProfile.json\" -o -name \"*.swp\" -o -name \"security.sav\" -o -name \"*.p12\" -o -name \"server.xml\" -o -name \"id_dsa*\" -o -name \"tomcat-users.xml\" -o -name \"ftp.config\" -o -name \"settings.php\" -o -name \"iis6.log\" -o -name \"wcx_ftp.ini\" -o -name \"*.viminfo\" -o -name \"system.sav\" -o -name \"*.pfx\" -o -name \"docker.socket\" -o -name \"httpd.conf\" -o -name \".env\" -o -name \"filezilla.xml\" -o -name \"*.service\" -o -name \"KeePass.ini\" -o -name \"software.sav\" -o -name \"setupinfo\" -o -name \"wsl.exe\" -o -name \"authorized_keys\" -o -name \"winscp.ini\" -o -name \"my.cnf\" -o -name \"NetSetup.log\" -o -name \"backups\" -o -name \"*.pgp\" -o -name \"*vnc*.c*nf*\" -o -name \"*.gpg\" -o -name \"unattend.inf\" -o -name \"setupinfo.bak\" -o -name \"ipsec.conf\" -o -name \"passwd\" -o -name \"autologin.conf\" -o -name \"AzureRMContext.json\" -o -name \"fastcgi_params\" -o -name \"KeePass.enforced*\" -o -name \"*.csr\" -o -name \".htpasswd\" -o -name \"pagefile.sys\" -o -name \"*credential*\" -o -name \"krb5.keytab\" -o -name \"ffftp.ini\" -o -name \"known_hosts\" -o -name \"recentservers.xml\" -o -name \"scheduledtasks.xml\" -o -name \"KeePass.config*\" -o -name \"anaconda-ks.cfg\" -o -name \"credentials.db\" -o -name \"pgadmin*.db\" -o -name \"gvm-tools.conf\" -o -name \"gitlab.yml\" -o -name \"error.log\" -o -name \"authorized_hosts\" -o -name \"ConsoleHost_history.txt\" -o -name \"protecteduserkey.bin\" -o -name \"docker.sock\" -o -name \"*password*\" -o -name \"accessTokens.json\" -o -name \"autologin\" -o -name \"*.crt\" -o -name \"storage.php\" -o -name \"legacy_credentials.db\" -o -name \"TokenCache.dat\" -o -name \".gitconfig\" -o -name \"pg_hba.conf\" -o -name \"*.ovpn\" -o -name \"db.php\" -o -name \"*.kdbx\" -o -name \"https.conf\" -o -name \"drives.xml\" -o -name \"index.dat\" -o -name \"RDCMan.settings\" -o -name \"supervisord.conf\" -o -name \"config.php\" -o -name \"hostapd.conf\" -o -name \".git-credentials\" -o -name \"appcmd.exe\" -o -name \"sess_*\" -o -name \"ws_ftp.ini\" -o -name \"web*.config\" -o -name \"000-default.conf\" -o -name \".bashrc\" -o -name \"php.ini\" -o -name \"SYSTEM\" -o -name \"rsyncd.conf\" -o -name \"scclient.exe\" -o -name \".lesshst\" -o -name \"creds*\" -o -name \".github\" -o -name \".sudo_as_admin_successful\" -o -name \"cloud.cfg\" -o -name \"datasources.xml\" -o -name \"AppEvent.Evt\" -o -name \".ldaprc\" -o -name \"my.ini\" -o -name \".plan\" -o -name \"sites.ini\" -o -name \"gitlab.rm\" -o -name \"*.sqlite3\" -o -name \"*.timer\" -o -name \"hosts.equiv\" -o -name \"Ntds.dit\" -o -name \"software\" -o -name \".rhosts\" -o -name \"kibana.y*ml\" -o -name \"ftp.ini\" -o -name \"sysprep.inf\" -o -name \"rsyncd.secrets\" -o -name \".k5login\" -o -name \"mosquitto.conf\" -o -name \"https-xampp.conf\" -o -name \"*.db\" -o -name \"snmpd.conf\" -o -name \"cesi.conf\" -o -name \"*.ftpconfig\" -o -name \"*.sqlite\" -o -name \"backup\" -o -name \".*_history.*\" -o -name \"SecEvent.Evt\" -o -name \"unattend.txt\" -o -name \"printers.xml\" -o -name \"mongod*.conf\" -o -name \"*.keystore\" -o -name \"unattend.xml\" -o -name \"krb5.conf\" -o -name \"groups.xml\" -o -name \"*.jks\" -o -name \"sysprep.xml\" -o -name \"*config*.php\" -o -name \"ipsec.secrets\" -o -name \"*.socket\" -o -name \"credentials\" -o -name \".vault-token\" -o -name \".profile\" -o -name \"postgresql.conf\" -o -name \".google_authenticator\" -o -name \"ntuser.dat\" -o -name \"pgsql.conf\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_OPT=`eval_bckgrd "find /opt -name \".pypirc\" -o -name \"*vnc*.ini\" -o -name \"SAM\" -o -name \".recently-used.xbel\" -o -name \"*vnc*.txt\" -o -name \"*.gnupg\" -o -name \"redis.conf\" -o -name \"*vnc*.xml\" -o -name \"id_rsa*\" -o -name \"access_tokens.db\" -o -name \"*.pem\" -o -name \"*.keyring\" -o -name \"kadm5.acl\" -o -name \"wp-config.php\" -o -name \"database.php\" -o -name \"docker-compose.yml\" -o -name \".git\" -o -name \"unattended.xml\" -o -name \"bash.exe\" -o -name \"*.key\" -o -name \"elasticsearch.y*ml\" -o -name \"debian.cnf\" -o -name \".msmtprc\" -o -name \"Dockerfile\" -o -name \"*.rdg\" -o -name \"access_tokens.json\" -o -name \"access.log\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.der\" -o -name \"default.sav\" -o -name \"sitemanager.xml\" -o -name \".erlang.cookie\" -o -name \"vault-ssh-helper.hcl\" -o -name \"ddclient.conf\" -o -name \"kcpassword\" -o -name \"secrets.yml\" -o -name \"*.cer\" -o -name \"azureProfile.json\" -o -name \"*.swp\" -o -name \"security.sav\" -o -name \"*.p12\" -o -name \"server.xml\" -o -name \"id_dsa*\" -o -name \"tomcat-users.xml\" -o -name \"ftp.config\" -o -name \"settings.php\" -o -name \"iis6.log\" -o -name \"wcx_ftp.ini\" -o -name \"*.viminfo\" -o -name \"system.sav\" -o -name \"*.pfx\" -o -name \"docker.socket\" -o -name \"httpd.conf\" -o -name \".env\" -o -name \"filezilla.xml\" -o -name \"*.service\" -o -name \"KeePass.ini\" -o -name \"software.sav\" -o -name \"setupinfo\" -o -name \"wsl.exe\" -o -name \"authorized_keys\" -o -name \"winscp.ini\" -o -name \"my.cnf\" -o -name \"NetSetup.log\" -o -name \"backups\" -o -name \"*.pgp\" -o -name \"*vnc*.c*nf*\" -o -name \"*.gpg\" -o -name \"unattend.inf\" -o -name \"setupinfo.bak\" -o -name \"ipsec.conf\" -o -name \"passwd\" -o -name \"autologin.conf\" -o -name \"AzureRMContext.json\" -o -name \"fastcgi_params\" -o -name \"KeePass.enforced*\" -o -name \"*.csr\" -o -name \".htpasswd\" -o -name \"pagefile.sys\" -o -name \"*credential*\" -o -name \"krb5.keytab\" -o -name \"ffftp.ini\" -o -name \"known_hosts\" -o -name \"recentservers.xml\" -o -name \"scheduledtasks.xml\" -o -name \"KeePass.config*\" -o -name \"anaconda-ks.cfg\" -o -name \"credentials.db\" -o -name \"pgadmin*.db\" -o -name \"gvm-tools.conf\" -o -name \"gitlab.yml\" -o -name \"error.log\" -o -name \"authorized_hosts\" -o -name \"ConsoleHost_history.txt\" -o -name \"protecteduserkey.bin\" -o -name \"docker.sock\" -o -name \"*password*\" -o -name \"accessTokens.json\" -o -name \"autologin\" -o -name \"*.crt\" -o -name \"storage.php\" -o -name \"legacy_credentials.db\" -o -name \"TokenCache.dat\" -o -name \".gitconfig\" -o -name \"pg_hba.conf\" -o -name \"*.ovpn\" -o -name \"db.php\" -o -name \"*.kdbx\" -o -name \"https.conf\" -o -name \"drives.xml\" -o -name \"index.dat\" -o -name \"RDCMan.settings\" -o -name \"supervisord.conf\" -o -name \"config.php\" -o -name \"hostapd.conf\" -o -name \".git-credentials\" -o -name \"appcmd.exe\" -o -name \"ws_ftp.ini\" -o -name \"web*.config\" -o -name \"000-default.conf\" -o -name \".bashrc\" -o -name \"php.ini\" -o -name \"SYSTEM\" -o -name \"rsyncd.conf\" -o -name \"scclient.exe\" -o -name \".lesshst\" -o -name \"creds*\" -o -name \".github\" -o -name \".sudo_as_admin_successful\" -o -name \"cloud.cfg\" -o -name \"datasources.xml\" -o -name \"AppEvent.Evt\" -o -name \".ldaprc\" -o -name \"my.ini\" -o -name \".plan\" -o -name \"sites.ini\" -o -name \"gitlab.rm\" -o -name \"*.sqlite3\" -o -name \"*.timer\" -o -name \"hosts.equiv\" -o -name \"Ntds.dit\" -o -name \"software\" -o -name \".rhosts\" -o -name \"kibana.y*ml\" -o -name \"ftp.ini\" -o -name \"sysprep.inf\" -o -name \"rsyncd.secrets\" -o -name \".k5login\" -o -name \"mosquitto.conf\" -o -name \"https-xampp.conf\" -o -name \"*.db\" -o -name \"snmpd.conf\" -o -name \"cesi.conf\" -o -name \"*.ftpconfig\" -o -name \"*.sqlite\" -o -name \"backup\" -o -name \".*_history.*\" -o -name \"SecEvent.Evt\" -o -name \"unattend.txt\" -o -name \"printers.xml\" -o -name \"mongod*.conf\" -o -name \"*.keystore\" -o -name \"unattend.xml\" -o -name \"krb5.conf\" -o -name \"groups.xml\" -o -name \"*.jks\" -o -name \"sysprep.xml\" -o -name \"*config*.php\" -o -name \"ipsec.secrets\" -o -name \"*.socket\" -o -name \"credentials\" -o -name \".vault-token\" -o -name \".profile\" -o -name \"postgresql.conf\" -o -name \".google_authenticator\" -o -name \"ntuser.dat\" -o -name \"pgsql.conf\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_PRIVATE=`eval_bckgrd "find /private -name \".pypirc\" -o -name \"*vnc*.ini\" -o -name \"SAM\" -o -name \".recently-used.xbel\" -o -name \"*vnc*.txt\" -o -name \"*.gnupg\" -o -name \"redis.conf\" -o -name \"*vnc*.xml\" -o -name \"id_rsa*\" -o -name \"access_tokens.db\" -o -name \"*.pem\" -o -name \"*.keyring\" -o -name \"kadm5.acl\" -o -name \"wp-config.php\" -o -name \"database.php\" -o -name \"docker-compose.yml\" -o -name \".git\" -o -name \"unattended.xml\" -o -name \"bash.exe\" -o -name \"*.key\" -o -name \"elasticsearch.y*ml\" -o -name \"debian.cnf\" -o -name \".msmtprc\" -o -name \"Dockerfile\" -o -name \"*.rdg\" -o -name \"access_tokens.json\" -o -name \"access.log\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.der\" -o -name \"default.sav\" -o -name \"sitemanager.xml\" -o -name \".erlang.cookie\" -o -name \"vault-ssh-helper.hcl\" -o -name \"ddclient.conf\" -o -name \"kcpassword\" -o -name \"secrets.yml\" -o -name \"*.cer\" -o -name \"azureProfile.json\" -o -name \"*.swp\" -o -name \"security.sav\" -o -name \"*.p12\" -o -name \"server.xml\" -o -name \"id_dsa*\" -o -name \"tomcat-users.xml\" -o -name \"ftp.config\" -o -name \"settings.php\" -o -name \"iis6.log\" -o -name \"wcx_ftp.ini\" -o -name \"*.viminfo\" -o -name \"system.sav\" -o -name \"*.pfx\" -o -name \"docker.socket\" -o -name \"httpd.conf\" -o -name \".env\" -o -name \"filezilla.xml\" -o -name \"*.service\" -o -name \"KeePass.ini\" -o -name \"software.sav\" -o -name \"setupinfo\" -o -name \"wsl.exe\" -o -name \"authorized_keys\" -o -name \"winscp.ini\" -o -name \"my.cnf\" -o -name \"NetSetup.log\" -o -name \"backups\" -o -name \"*.pgp\" -o -name \"*vnc*.c*nf*\" -o -name \"*.gpg\" -o -name \"unattend.inf\" -o -name \"setupinfo.bak\" -o -name \"ipsec.conf\" -o -name \"passwd\" -o -name \"autologin.conf\" -o -name \"AzureRMContext.json\" -o -name \"fastcgi_params\" -o -name \"KeePass.enforced*\" -o -name \"*.csr\" -o -name \".htpasswd\" -o -name \"pagefile.sys\" -o -name \"*credential*\" -o -name \"krb5.keytab\" -o -name \"ffftp.ini\" -o -name \"known_hosts\" -o -name \"recentservers.xml\" -o -name \"scheduledtasks.xml\" -o -name \"KeePass.config*\" -o -name \"anaconda-ks.cfg\" -o -name \"credentials.db\" -o -name \"pgadmin*.db\" -o -name \"gvm-tools.conf\" -o -name \"gitlab.yml\" -o -name \"error.log\" -o -name \"authorized_hosts\" -o -name \"ConsoleHost_history.txt\" -o -name \"protecteduserkey.bin\" -o -name \"docker.sock\" -o -name \"*password*\" -o -name \"accessTokens.json\" -o -name \"autologin\" -o -name \"*.crt\" -o -name \"storage.php\" -o -name \"legacy_credentials.db\" -o -name \"TokenCache.dat\" -o -name \".gitconfig\" -o -name \"pg_hba.conf\" -o -name \"*.ovpn\" -o -name \"db.php\" -o -name \"*.kdbx\" -o -name \"https.conf\" -o -name \"drives.xml\" -o -name \"index.dat\" -o -name \"RDCMan.settings\" -o -name \"supervisord.conf\" -o -name \"config.php\" -o -name \"hostapd.conf\" -o -name \".git-credentials\" -o -name \"appcmd.exe\" -o -name \"sess_*\" -o -name \"ws_ftp.ini\" -o -name \"web*.config\" -o -name \"000-default.conf\" -o -name \".bashrc\" -o -name \"php.ini\" -o -name \"SYSTEM\" -o -name \"rsyncd.conf\" -o -name \"scclient.exe\" -o -name \".lesshst\" -o -name \"creds*\" -o -name \".github\" -o -name \".sudo_as_admin_successful\" -o -name \"cloud.cfg\" -o -name \"datasources.xml\" -o -name \"AppEvent.Evt\" -o -name \".ldaprc\" -o -name \"my.ini\" -o -name \".plan\" -o -name \"sites.ini\" -o -name \"gitlab.rm\" -o -name \"*.sqlite3\" -o -name \"*.timer\" -o -name \"hosts.equiv\" -o -name \"agent*\" -o -name \"Ntds.dit\" -o -name \"software\" -o -name \".rhosts\" -o -name \"kibana.y*ml\" -o -name \"ftp.ini\" -o -name \"sysprep.inf\" -o -name \"rsyncd.secrets\" -o -name \".k5login\" -o -name \"mosquitto.conf\" -o -name \"https-xampp.conf\" -o -name \"*.db\" -o -name \"snmpd.conf\" -o -name \"cesi.conf\" -o -name \"*.ftpconfig\" -o -name \"*.sqlite\" -o -name \"backup\" -o -name \".*_history.*\" -o -name \"SecEvent.Evt\" -o -name \"unattend.txt\" -o -name \"printers.xml\" -o -name \"mongod*.conf\" -o -name \"*.keystore\" -o -name \"unattend.xml\" -o -name \"krb5.conf\" -o -name \"groups.xml\" -o -name \"*.jks\" -o -name \"sysprep.xml\" -o -name \"*config*.php\" -o -name \"ipsec.secrets\" -o -name \"*.socket\" -o -name \"credentials\" -o -name \".vault-token\" -o -name \".profile\" -o -name \"postgresql.conf\" -o -name \".google_authenticator\" -o -name \"ntuser.dat\" -o -name \"pgsql.conf\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_RUN=`eval_bckgrd "find /run -name \"*.timer\" -o -name \"*.socket\" -o -name \"*.service\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_SBIN=`eval_bckgrd "find /sbin -name \".pypirc\" -o -name \"*vnc*.ini\" -o -name \"SAM\" -o -name \".recently-used.xbel\" -o -name \"*vnc*.txt\" -o -name \"*.gnupg\" -o -name \"redis.conf\" -o -name \"*vnc*.xml\" -o -name \"id_rsa*\" -o -name \"access_tokens.db\" -o -name \"*.pem\" -o -name \"*.keyring\" -o -name \"kadm5.acl\" -o -name \"wp-config.php\" -o -name \"database.php\" -o -name \"docker-compose.yml\" -o -name \".git\" -o -name \"unattended.xml\" -o -name \"bash.exe\" -o -name \"*.key\" -o -name \"elasticsearch.y*ml\" -o -name \"debian.cnf\" -o -name \".msmtprc\" -o -name \"Dockerfile\" -o -name \"*.rdg\" -o -name \"access_tokens.json\" -o -name \"access.log\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.der\" -o -name \"default.sav\" -o -name \"sitemanager.xml\" -o -name \".erlang.cookie\" -o -name \"vault-ssh-helper.hcl\" -o -name \"ddclient.conf\" -o -name \"kcpassword\" -o -name \"secrets.yml\" -o -name \"*.cer\" -o -name \"azureProfile.json\" -o -name \"*.swp\" -o -name \"security.sav\" -o -name \"*.p12\" -o -name \"server.xml\" -o -name \"id_dsa*\" -o -name \"tomcat-users.xml\" -o -name \"ftp.config\" -o -name \"settings.php\" -o -name \"iis6.log\" -o -name \"wcx_ftp.ini\" -o -name \"*.viminfo\" -o -name \"system.sav\" -o -name \"*.pfx\" -o -name \"docker.socket\" -o -name \"httpd.conf\" -o -name \".env\" -o -name \"filezilla.xml\" -o -name \"*.service\" -o -name \"KeePass.ini\" -o -name \"software.sav\" -o -name \"setupinfo\" -o -name \"wsl.exe\" -o -name \"authorized_keys\" -o -name \"winscp.ini\" -o -name \"my.cnf\" -o -name \"NetSetup.log\" -o -name \"backups\" -o -name \"*.pgp\" -o -name \"*vnc*.c*nf*\" -o -name \"*.gpg\" -o -name \"unattend.inf\" -o -name \"setupinfo.bak\" -o -name \"ipsec.conf\" -o -name \"passwd\" -o -name \"autologin.conf\" -o -name \"AzureRMContext.json\" -o -name \"fastcgi_params\" -o -name \"KeePass.enforced*\" -o -name \"*.csr\" -o -name \".htpasswd\" -o -name \"pagefile.sys\" -o -name \"*credential*\" -o -name \"krb5.keytab\" -o -name \"ffftp.ini\" -o -name \"known_hosts\" -o -name \"recentservers.xml\" -o -name \"scheduledtasks.xml\" -o -name \"KeePass.config*\" -o -name \"anaconda-ks.cfg\" -o -name \"credentials.db\" -o -name \"pgadmin*.db\" -o -name \"gvm-tools.conf\" -o -name \"gitlab.yml\" -o -name \"error.log\" -o -name \"authorized_hosts\" -o -name \"ConsoleHost_history.txt\" -o -name \"protecteduserkey.bin\" -o -name \"docker.sock\" -o -name \"*password*\" -o -name \"accessTokens.json\" -o -name \"autologin\" -o -name \"*.crt\" -o -name \"storage.php\" -o -name \"legacy_credentials.db\" -o -name \"TokenCache.dat\" -o -name \".gitconfig\" -o -name \"pg_hba.conf\" -o -name \"*.ovpn\" -o -name \"db.php\" -o -name \"*.kdbx\" -o -name \"https.conf\" -o -name \"drives.xml\" -o -name \"index.dat\" -o -name \"RDCMan.settings\" -o -name \"supervisord.conf\" -o -name \"config.php\" -o -name \"hostapd.conf\" -o -name \".git-credentials\" -o -name \"appcmd.exe\" -o -name \"ws_ftp.ini\" -o -name \"web*.config\" -o -name \"000-default.conf\" -o -name \".bashrc\" -o -name \"php.ini\" -o -name \"SYSTEM\" -o -name \"rsyncd.conf\" -o -name \"scclient.exe\" -o -name \".lesshst\" -o -name \"creds*\" -o -name \".github\" -o -name \".sudo_as_admin_successful\" -o -name \"cloud.cfg\" -o -name \"datasources.xml\" -o -name \"AppEvent.Evt\" -o -name \".ldaprc\" -o -name \"my.ini\" -o -name \".plan\" -o -name \"sites.ini\" -o -name \"gitlab.rm\" -o -name \"*.sqlite3\" -o -name \"*.timer\" -o -name \"hosts.equiv\" -o -name \"Ntds.dit\" -o -name \"software\" -o -name \".rhosts\" -o -name \"kibana.y*ml\" -o -name \"ftp.ini\" -o -name \"sysprep.inf\" -o -name \"rsyncd.secrets\" -o -name \".k5login\" -o -name \"mosquitto.conf\" -o -name \"https-xampp.conf\" -o -name \"*.db\" -o -name \"snmpd.conf\" -o -name \"cesi.conf\" -o -name \"*.ftpconfig\" -o -name \"*.sqlite\" -o -name \"backup\" -o -name \".*_history.*\" -o -name \"SecEvent.Evt\" -o -name \"unattend.txt\" -o -name \"printers.xml\" -o -name \"mongod*.conf\" -o -name \"*.keystore\" -o -name \"unattend.xml\" -o -name \"krb5.conf\" -o -name \"groups.xml\" -o -name \"*.jks\" -o -name \"sysprep.xml\" -o -name \"*config*.php\" -o -name \"ipsec.secrets\" -o -name \"*.socket\" -o -name \"credentials\" -o -name \".vault-token\" -o -name \".profile\" -o -name \"postgresql.conf\" -o -name \".google_authenticator\" -o -name \"ntuser.dat\" -o -name \"pgsql.conf\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_SNAP=`eval_bckgrd "find /snap -name \".pypirc\" -o -name \"*vnc*.ini\" -o -name \"SAM\" -o -name \".recently-used.xbel\" -o -name \"*vnc*.txt\" -o -name \"*.gnupg\" -o -name \"redis.conf\" -o -name \"*vnc*.xml\" -o -name \"id_rsa*\" -o -name \"access_tokens.db\" -o -name \"*.pem\" -o -name \"*.keyring\" -o -name \"kadm5.acl\" -o -name \"wp-config.php\" -o -name \"database.php\" -o -name \"docker-compose.yml\" -o -name \".git\" -o -name \"unattended.xml\" -o -name \"bash.exe\" -o -name \"*.key\" -o -name \"elasticsearch.y*ml\" -o -name \"debian.cnf\" -o -name \".msmtprc\" -o -name \"Dockerfile\" -o -name \"*.rdg\" -o -name \"access_tokens.json\" -o -name \"access.log\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.der\" -o -name \"default.sav\" -o -name \"sitemanager.xml\" -o -name \".erlang.cookie\" -o -name \"vault-ssh-helper.hcl\" -o -name \"ddclient.conf\" -o -name \"kcpassword\" -o -name \"secrets.yml\" -o -name \"*.cer\" -o -name \"azureProfile.json\" -o -name \"*.swp\" -o -name \"security.sav\" -o -name \"*.p12\" -o -name \"server.xml\" -o -name \"id_dsa*\" -o -name \"tomcat-users.xml\" -o -name \"ftp.config\" -o -name \"settings.php\" -o -name \"iis6.log\" -o -name \"wcx_ftp.ini\" -o -name \"*.viminfo\" -o -name \"system.sav\" -o -name \"*.pfx\" -o -name \"docker.socket\" -o -name \"httpd.conf\" -o -name \".env\" -o -name \"filezilla.xml\" -o -name \"*.service\" -o -name \"KeePass.ini\" -o -name \"software.sav\" -o -name \"setupinfo\" -o -name \"wsl.exe\" -o -name \"authorized_keys\" -o -name \"winscp.ini\" -o -name \"my.cnf\" -o -name \"NetSetup.log\" -o -name \"backups\" -o -name \"*.pgp\" -o -name \"*vnc*.c*nf*\" -o -name \"*.gpg\" -o -name \"unattend.inf\" -o -name \"setupinfo.bak\" -o -name \"ipsec.conf\" -o -name \"passwd\" -o -name \"autologin.conf\" -o -name \"AzureRMContext.json\" -o -name \"fastcgi_params\" -o -name \"KeePass.enforced*\" -o -name \"*.csr\" -o -name \".htpasswd\" -o -name \"pagefile.sys\" -o -name \"*credential*\" -o -name \"krb5.keytab\" -o -name \"ffftp.ini\" -o -name \"known_hosts\" -o -name \"recentservers.xml\" -o -name \"scheduledtasks.xml\" -o -name \"KeePass.config*\" -o -name \"anaconda-ks.cfg\" -o -name \"credentials.db\" -o -name \"pgadmin*.db\" -o -name \"gvm-tools.conf\" -o -name \"gitlab.yml\" -o -name \"error.log\" -o -name \"authorized_hosts\" -o -name \"ConsoleHost_history.txt\" -o -name \"protecteduserkey.bin\" -o -name \"docker.sock\" -o -name \"*password*\" -o -name \"accessTokens.json\" -o -name \"autologin\" -o -name \"*.crt\" -o -name \"storage.php\" -o -name \"legacy_credentials.db\" -o -name \"TokenCache.dat\" -o -name \".gitconfig\" -o -name \"pg_hba.conf\" -o -name \"*.ovpn\" -o -name \"db.php\" -o -name \"*.kdbx\" -o -name \"https.conf\" -o -name \"drives.xml\" -o -name \"index.dat\" -o -name \"RDCMan.settings\" -o -name \"supervisord.conf\" -o -name \"config.php\" -o -name \"hostapd.conf\" -o -name \".git-credentials\" -o -name \"appcmd.exe\" -o -name \"ws_ftp.ini\" -o -name \"web*.config\" -o -name \"000-default.conf\" -o -name \".bashrc\" -o -name \"php.ini\" -o -name \"SYSTEM\" -o -name \"rsyncd.conf\" -o -name \"scclient.exe\" -o -name \".lesshst\" -o -name \"creds*\" -o -name \".github\" -o -name \".sudo_as_admin_successful\" -o -name \"cloud.cfg\" -o -name \"datasources.xml\" -o -name \"AppEvent.Evt\" -o -name \".ldaprc\" -o -name \"my.ini\" -o -name \".plan\" -o -name \"sites.ini\" -o -name \"gitlab.rm\" -o -name \"*.sqlite3\" -o -name \"*.timer\" -o -name \"hosts.equiv\" -o -name \"Ntds.dit\" -o -name \"software\" -o -name \".rhosts\" -o -name \"kibana.y*ml\" -o -name \"ftp.ini\" -o -name \"sysprep.inf\" -o -name \"rsyncd.secrets\" -o -name \".k5login\" -o -name \"mosquitto.conf\" -o -name \"https-xampp.conf\" -o -name \"*.db\" -o -name \"snmpd.conf\" -o -name \"cesi.conf\" -o -name \"*.ftpconfig\" -o -name \"*.sqlite\" -o -name \"backup\" -o -name \".*_history.*\" -o -name \"SecEvent.Evt\" -o -name \"unattend.txt\" -o -name \"printers.xml\" -o -name \"mongod*.conf\" -o -name \"*.keystore\" -o -name \"unattend.xml\" -o -name \"krb5.conf\" -o -name \"groups.xml\" -o -name \"*.jks\" -o -name \"sysprep.xml\" -o -name \"*config*.php\" -o -name \"ipsec.secrets\" -o -name \"*.socket\" -o -name \"credentials\" -o -name \".vault-token\" -o -name \".profile\" -o -name \"postgresql.conf\" -o -name \".google_authenticator\" -o -name \"ntuser.dat\" -o -name \"pgsql.conf\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_SRV=`eval_bckgrd "find /srv -name \".pypirc\" -o -name \"*vnc*.ini\" -o -name \"SAM\" -o -name \".recently-used.xbel\" -o -name \"*vnc*.txt\" -o -name \"*.gnupg\" -o -name \"redis.conf\" -o -name \"*vnc*.xml\" -o -name \"id_rsa*\" -o -name \"access_tokens.db\" -o -name \"*.pem\" -o -name \"*.keyring\" -o -name \"kadm5.acl\" -o -name \"wp-config.php\" -o -name \"database.php\" -o -name \"docker-compose.yml\" -o -name \".git\" -o -name \"unattended.xml\" -o -name \"bash.exe\" -o -name \"*.key\" -o -name \"elasticsearch.y*ml\" -o -name \"debian.cnf\" -o -name \".msmtprc\" -o -name \"Dockerfile\" -o -name \"*.rdg\" -o -name \"access_tokens.json\" -o -name \"access.log\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.der\" -o -name \"default.sav\" -o -name \"sitemanager.xml\" -o -name \".erlang.cookie\" -o -name \"vault-ssh-helper.hcl\" -o -name \"ddclient.conf\" -o -name \"kcpassword\" -o -name \"secrets.yml\" -o -name \"*.cer\" -o -name \"azureProfile.json\" -o -name \"*.swp\" -o -name \"security.sav\" -o -name \"*.p12\" -o -name \"server.xml\" -o -name \"id_dsa*\" -o -name \"tomcat-users.xml\" -o -name \"ftp.config\" -o -name \"settings.php\" -o -name \"iis6.log\" -o -name \"wcx_ftp.ini\" -o -name \"*.viminfo\" -o -name \"system.sav\" -o -name \"*.pfx\" -o -name \"docker.socket\" -o -name \"httpd.conf\" -o -name \".env\" -o -name \"filezilla.xml\" -o -name \"*.service\" -o -name \"KeePass.ini\" -o -name \"software.sav\" -o -name \"setupinfo\" -o -name \"wsl.exe\" -o -name \"authorized_keys\" -o -name \"winscp.ini\" -o -name \"my.cnf\" -o -name \"NetSetup.log\" -o -name \"backups\" -o -name \"*.pgp\" -o -name \"*vnc*.c*nf*\" -o -name \"*.gpg\" -o -name \"unattend.inf\" -o -name \"setupinfo.bak\" -o -name \"ipsec.conf\" -o -name \"passwd\" -o -name \"autologin.conf\" -o -name \"AzureRMContext.json\" -o -name \"fastcgi_params\" -o -name \"KeePass.enforced*\" -o -name \"*.csr\" -o -name \".htpasswd\" -o -name \"pagefile.sys\" -o -name \"*credential*\" -o -name \"krb5.keytab\" -o -name \"ffftp.ini\" -o -name \"known_hosts\" -o -name \"recentservers.xml\" -o -name \"scheduledtasks.xml\" -o -name \"KeePass.config*\" -o -name \"anaconda-ks.cfg\" -o -name \"credentials.db\" -o -name \"pgadmin*.db\" -o -name \"gvm-tools.conf\" -o -name \"gitlab.yml\" -o -name \"error.log\" -o -name \"authorized_hosts\" -o -name \"ConsoleHost_history.txt\" -o -name \"protecteduserkey.bin\" -o -name \"docker.sock\" -o -name \"*password*\" -o -name \"accessTokens.json\" -o -name \"autologin\" -o -name \"*.crt\" -o -name \"storage.php\" -o -name \"legacy_credentials.db\" -o -name \"TokenCache.dat\" -o -name \".gitconfig\" -o -name \"pg_hba.conf\" -o -name \"*.ovpn\" -o -name \"db.php\" -o -name \"*.kdbx\" -o -name \"https.conf\" -o -name \"drives.xml\" -o -name \"index.dat\" -o -name \"RDCMan.settings\" -o -name \"supervisord.conf\" -o -name \"config.php\" -o -name \"hostapd.conf\" -o -name \".git-credentials\" -o -name \"appcmd.exe\" -o -name \"ws_ftp.ini\" -o -name \"web*.config\" -o -name \"000-default.conf\" -o -name \".bashrc\" -o -name \"php.ini\" -o -name \"SYSTEM\" -o -name \"rsyncd.conf\" -o -name \"scclient.exe\" -o -name \".lesshst\" -o -name \"creds*\" -o -name \".github\" -o -name \".sudo_as_admin_successful\" -o -name \"cloud.cfg\" -o -name \"datasources.xml\" -o -name \"AppEvent.Evt\" -o -name \".ldaprc\" -o -name \"my.ini\" -o -name \".plan\" -o -name \"sites.ini\" -o -name \"gitlab.rm\" -o -name \"*.sqlite3\" -o -name \"*.timer\" -o -name \"hosts.equiv\" -o -name \"Ntds.dit\" -o -name \"software\" -o -name \".rhosts\" -o -name \"kibana.y*ml\" -o -name \"ftp.ini\" -o -name \"sysprep.inf\" -o -name \"rsyncd.secrets\" -o -name \".k5login\" -o -name \"mosquitto.conf\" -o -name \"https-xampp.conf\" -o -name \"*.db\" -o -name \"snmpd.conf\" -o -name \"cesi.conf\" -o -name \"*.ftpconfig\" -o -name \"*.sqlite\" -o -name \"backup\" -o -name \".*_history.*\" -o -name \"SecEvent.Evt\" -o -name \"unattend.txt\" -o -name \"printers.xml\" -o -name \"mongod*.conf\" -o -name \"*.keystore\" -o -name \"unattend.xml\" -o -name \"krb5.conf\" -o -name \"groups.xml\" -o -name \"*.jks\" -o -name \"sysprep.xml\" -o -name \"*config*.php\" -o -name \"ipsec.secrets\" -o -name \"*.socket\" -o -name \"credentials\" -o -name \".vault-token\" -o -name \".profile\" -o -name \"postgresql.conf\" -o -name \".google_authenticator\" -o -name \"ntuser.dat\" -o -name \"pgsql.conf\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  FIND_TMP=`eval_bckgrd "find /tmp -name \".pypirc\" -o -name \"*vnc*.ini\" -o -name \"SAM\" -o -name \".recently-used.xbel\" -o -name \"*vnc*.txt\" -o -name \"*.gnupg\" -o -name \"redis.conf\" -o -name \"*vnc*.xml\" -o -name \"id_rsa*\" -o -name \"access_tokens.db\" -o -name \"*.pem\" -o -name \"*.keyring\" -o -name \"kadm5.acl\" -o -name \"wp-config.php\" -o -name \"database.php\" -o -name \"docker-compose.yml\" -o -name \".git\" -o -name \"unattended.xml\" -o -name \"bash.exe\" -o -name \"*.key\" -o -name \"elasticsearch.y*ml\" -o -name \"debian.cnf\" -o -name \".msmtprc\" -o -name \"Dockerfile\" -o -name \"*.rdg\" -o -name \"access_tokens.json\" -o -name \"access.log\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.der\" -o -name \"default.sav\" -o -name \"sitemanager.xml\" -o -name \".erlang.cookie\" -o -name \"vault-ssh-helper.hcl\" -o -name \"ddclient.conf\" -o -name \"kcpassword\" -o -name \"secrets.yml\" -o -name \"*.cer\" -o -name \"azureProfile.json\" -o -name \"*.swp\" -o -name \"security.sav\" -o -name \"*.p12\" -o -name \"server.xml\" -o -name \"id_dsa*\" -o -name \"tomcat-users.xml\" -o -name \"ftp.config\" -o -name \"settings.php\" -o -name \"iis6.log\" -o -name \"wcx_ftp.ini\" -o -name \"*.viminfo\" -o -name \"system.sav\" -o -name \"*.pfx\" -o -name \"docker.socket\" -o -name \"httpd.conf\" -o -name \".env\" -o -name \"filezilla.xml\" -o -name \"*.service\" -o -name \"KeePass.ini\" -o -name \"software.sav\" -o -name \"setupinfo\" -o -name \"wsl.exe\" -o -name \"authorized_keys\" -o -name \"winscp.ini\" -o -name \"my.cnf\" -o -name \"NetSetup.log\" -o -name \"backups\" -o -name \"*.pgp\" -o -name \"*vnc*.c*nf*\" -o -name \"*.gpg\" -o -name \"unattend.inf\" -o -name \"setupinfo.bak\" -o -name \"ipsec.conf\" -o -name \"passwd\" -o -name \"autologin.conf\" -o -name \"AzureRMContext.json\" -o -name \"fastcgi_params\" -o -name \"KeePass.enforced*\" -o -name \"*.csr\" -o -name \".htpasswd\" -o -name \"pagefile.sys\" -o -name \"*credential*\" -o -name \"krb5.keytab\" -o -name \"ffftp.ini\" -o -name \"known_hosts\" -o -name \"recentservers.xml\" -o -name \"scheduledtasks.xml\" -o -name \"KeePass.config*\" -o -name \"anaconda-ks.cfg\" -o -name \"credentials.db\" -o -name \"pgadmin*.db\" -o -name \"gvm-tools.conf\" -o -name \"gitlab.yml\" -o -name \"error.log\" -o -name \"authorized_hosts\" -o -name \"ConsoleHost_history.txt\" -o -name \"protecteduserkey.bin\" -o -name \"docker.sock\" -o -name \"*password*\" -o -name \"accessTokens.json\" -o -name \"autologin\" -o -name \"*.crt\" -o -name \"storage.php\" -o -name \"legacy_credentials.db\" -o -name \"TokenCache.dat\" -o -name \".gitconfig\" -o -name \"pg_hba.conf\" -o -name \"*.ovpn\" -o -name \"db.php\" -o -name \"*.kdbx\" -o -name \"https.conf\" -o -name \"drives.xml\" -o -name \"index.dat\" -o -name \"RDCMan.settings\" -o -name \"supervisord.conf\" -o -name \"config.php\" -o -name \"hostapd.conf\" -o -name \".git-credentials\" -o -name \"appcmd.exe\" -o -name \"sess_*\" -o -name \"ws_ftp.ini\" -o -name \"web*.config\" -o -name \"000-default.conf\" -o -name \".bashrc\" -o -name \"php.ini\" -o -name \"SYSTEM\" -o -name \"rsyncd.conf\" -o -name \"scclient.exe\" -o -name \".lesshst\" -o -name \"creds*\" -o -name \".github\" -o -name \".sudo_as_admin_successful\" -o -name \"cloud.cfg\" -o -name \"datasources.xml\" -o -name \"AppEvent.Evt\" -o -name \".ldaprc\" -o -name \"my.ini\" -o -name \".plan\" -o -name \"sites.ini\" -o -name \"gitlab.rm\" -o -name \"*.sqlite3\" -o -name \"*.timer\" -o -name \"hosts.equiv\" -o -name \"agent*\" -o -name \"Ntds.dit\" -o -name \"software\" -o -name \".rhosts\" -o -name \"kibana.y*ml\" -o -name \"ftp.ini\" -o -name \"sysprep.inf\" -o -name \"rsyncd.secrets\" -o -name \".k5login\" -o -name \"mosquitto.conf\" -o -name \"https-xampp.conf\" -o -name \"*.db\" -o -name \"snmpd.conf\" -o -name \"cesi.conf\" -o -name \"*.ftpconfig\" -o -name \"*.sqlite\" -o -name \"backup\" -o -name \".*_history.*\" -o -name \"SecEvent.Evt\" -o -name \"unattend.txt\" -o -name \"printers.xml\" -o -name \"mongod*.conf\" -o -name \"*.keystore\" -o -name \"unattend.xml\" -o -name \"krb5.conf\" -o -name \"groups.xml\" -o -name \"*.jks\" -o -name \"sysprep.xml\" -o -name \"*config*.php\" -o -name \"ipsec.secrets\" -o -name \"*.socket\" -o -name \"credentials\" -o -name \".vault-token\" -o -name \".profile\" -o -name \"postgresql.conf\" -o -name \".google_authenticator\" -o -name \"ntuser.dat\" -o -name \"pgsql.conf\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_USR=`eval_bckgrd "find /usr -name \".pypirc\" -o -name \"*vnc*.ini\" -o -name \"SAM\" -o -name \".recently-used.xbel\" -o -name \"*vnc*.txt\" -o -name \"*.gnupg\" -o -name \"redis.conf\" -o -name \"*vnc*.xml\" -o -name \"id_rsa*\" -o -name \"access_tokens.db\" -o -name \"*.pem\" -o -name \"*.keyring\" -o -name \"kadm5.acl\" -o -name \"wp-config.php\" -o -name \"database.php\" -o -name \"docker-compose.yml\" -o -name \".git\" -o -name \"unattended.xml\" -o -name \"bash.exe\" -o -name \"*.key\" -o -name \"elasticsearch.y*ml\" -o -name \"debian.cnf\" -o -name \".msmtprc\" -o -name \"Dockerfile\" -o -name \"*.rdg\" -o -name \"access_tokens.json\" -o -name \"access.log\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.der\" -o -name \"default.sav\" -o -name \"sitemanager.xml\" -o -name \".erlang.cookie\" -o -name \"vault-ssh-helper.hcl\" -o -name \"ddclient.conf\" -o -name \"kcpassword\" -o -name \"secrets.yml\" -o -name \"*.cer\" -o -name \"azureProfile.json\" -o -name \"*.swp\" -o -name \"security.sav\" -o -name \"*.p12\" -o -name \"server.xml\" -o -name \"id_dsa*\" -o -name \"tomcat-users.xml\" -o -name \"ftp.config\" -o -name \"settings.php\" -o -name \"iis6.log\" -o -name \"wcx_ftp.ini\" -o -name \"*.viminfo\" -o -name \"system.sav\" -o -name \"*.pfx\" -o -name \"docker.socket\" -o -name \"httpd.conf\" -o -name \".env\" -o -name \"filezilla.xml\" -o -name \"*.service\" -o -name \"KeePass.ini\" -o -name \"software.sav\" -o -name \"setupinfo\" -o -name \"wsl.exe\" -o -name \"authorized_keys\" -o -name \"winscp.ini\" -o -name \"my.cnf\" -o -name \"NetSetup.log\" -o -name \"backups\" -o -name \"*.pgp\" -o -name \"*vnc*.c*nf*\" -o -name \"*.gpg\" -o -name \"unattend.inf\" -o -name \"setupinfo.bak\" -o -name \"ipsec.conf\" -o -name \"passwd\" -o -name \"autologin.conf\" -o -name \"AzureRMContext.json\" -o -name \"fastcgi_params\" -o -name \"KeePass.enforced*\" -o -name \"*.csr\" -o -name \".htpasswd\" -o -name \"pagefile.sys\" -o -name \"*credential*\" -o -name \"krb5.keytab\" -o -name \"ffftp.ini\" -o -name \"known_hosts\" -o -name \"recentservers.xml\" -o -name \"scheduledtasks.xml\" -o -name \"KeePass.config*\" -o -name \"anaconda-ks.cfg\" -o -name \"credentials.db\" -o -name \"pgadmin*.db\" -o -name \"gvm-tools.conf\" -o -name \"gitlab.yml\" -o -name \"error.log\" -o -name \"authorized_hosts\" -o -name \"ConsoleHost_history.txt\" -o -name \"protecteduserkey.bin\" -o -name \"docker.sock\" -o -name \"*password*\" -o -name \"accessTokens.json\" -o -name \"autologin\" -o -name \"*.crt\" -o -name \"storage.php\" -o -name \"legacy_credentials.db\" -o -name \"TokenCache.dat\" -o -name \".gitconfig\" -o -name \"pg_hba.conf\" -o -name \"*.ovpn\" -o -name \"db.php\" -o -name \"*.kdbx\" -o -name \"https.conf\" -o -name \"drives.xml\" -o -name \"index.dat\" -o -name \"RDCMan.settings\" -o -name \"supervisord.conf\" -o -name \"config.php\" -o -name \"hostapd.conf\" -o -name \".git-credentials\" -o -name \"appcmd.exe\" -o -name \"ws_ftp.ini\" -o -name \"web*.config\" -o -name \"000-default.conf\" -o -name \".bashrc\" -o -name \"php.ini\" -o -name \"SYSTEM\" -o -name \"rsyncd.conf\" -o -name \"scclient.exe\" -o -name \".lesshst\" -o -name \"creds*\" -o -name \".github\" -o -name \".sudo_as_admin_successful\" -o -name \"cloud.cfg\" -o -name \"datasources.xml\" -o -name \"AppEvent.Evt\" -o -name \".ldaprc\" -o -name \"my.ini\" -o -name \".plan\" -o -name \"sites.ini\" -o -name \"gitlab.rm\" -o -name \"*.sqlite3\" -o -name \"*.timer\" -o -name \"hosts.equiv\" -o -name \"Ntds.dit\" -o -name \"software\" -o -name \".rhosts\" -o -name \"kibana.y*ml\" -o -name \"ftp.ini\" -o -name \"sysprep.inf\" -o -name \"rsyncd.secrets\" -o -name \".k5login\" -o -name \"mosquitto.conf\" -o -name \"https-xampp.conf\" -o -name \"*.db\" -o -name \"snmpd.conf\" -o -name \"cesi.conf\" -o -name \"*.ftpconfig\" -o -name \"*.sqlite\" -o -name \"backup\" -o -name \".*_history.*\" -o -name \"SecEvent.Evt\" -o -name \"unattend.txt\" -o -name \"ssh*config\" -o -name \"printers.xml\" -o -name \"mongod*.conf\" -o -name \"*.keystore\" -o -name \"unattend.xml\" -o -name \"krb5.conf\" -o -name \"groups.xml\" -o -name \"*.jks\" -o -name \"sysprep.xml\" -o -name \"*config*.php\" -o -name \"ipsec.secrets\" -o -name \"*.socket\" -o -name \"credentials\" -o -name \".vault-token\" -o -name \".profile\" -o -name \"postgresql.conf\" -o -name \".google_authenticator\" -o -name \"ntuser.dat\" -o -name \"pgsql.conf\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_VAR=`eval_bckgrd "find /var -name \".pypirc\" -o -name \"*vnc*.ini\" -o -name \"SAM\" -o -name \".recently-used.xbel\" -o -name \"*vnc*.txt\" -o -name \"*.gnupg\" -o -name \"redis.conf\" -o -name \"*vnc*.xml\" -o -name \"id_rsa*\" -o -name \"access_tokens.db\" -o -name \"*.pem\" -o -name \"*.keyring\" -o -name \"kadm5.acl\" -o -name \"wp-config.php\" -o -name \"database.php\" -o -name \"docker-compose.yml\" -o -name \".git\" -o -name \"unattended.xml\" -o -name \"bash.exe\" -o -name \"*.key\" -o -name \"elasticsearch.y*ml\" -o -name \"debian.cnf\" -o -name \".msmtprc\" -o -name \"Dockerfile\" -o -name \"*.rdg\" -o -name \"access_tokens.json\" -o -name \"access.log\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.der\" -o -name \"default.sav\" -o -name \"sitemanager.xml\" -o -name \".erlang.cookie\" -o -name \"vault-ssh-helper.hcl\" -o -name \"ddclient.conf\" -o -name \"kcpassword\" -o -name \"secrets.yml\" -o -name \"*.cer\" -o -name \"azureProfile.json\" -o -name \"*.swp\" -o -name \"security.sav\" -o -name \"*.p12\" -o -name \"server.xml\" -o -name \"id_dsa*\" -o -name \"tomcat-users.xml\" -o -name \"ftp.config\" -o -name \"settings.php\" -o -name \"iis6.log\" -o -name \"wcx_ftp.ini\" -o -name \"*.viminfo\" -o -name \"system.sav\" -o -name \"*.pfx\" -o -name \"docker.socket\" -o -name \"httpd.conf\" -o -name \".env\" -o -name \"filezilla.xml\" -o -name \"*.service\" -o -name \"KeePass.ini\" -o -name \"software.sav\" -o -name \"setupinfo\" -o -name \"wsl.exe\" -o -name \"authorized_keys\" -o -name \"winscp.ini\" -o -name \"my.cnf\" -o -name \"NetSetup.log\" -o -name \"backups\" -o -name \"*.pgp\" -o -name \"*vnc*.c*nf*\" -o -name \"*.gpg\" -o -name \"unattend.inf\" -o -name \"setupinfo.bak\" -o -name \"ipsec.conf\" -o -name \"passwd\" -o -name \"autologin.conf\" -o -name \"AzureRMContext.json\" -o -name \"fastcgi_params\" -o -name \"KeePass.enforced*\" -o -name \"*.csr\" -o -name \".htpasswd\" -o -name \"pagefile.sys\" -o -name \"*credential*\" -o -name \"krb5.keytab\" -o -name \"ffftp.ini\" -o -name \"known_hosts\" -o -name \"recentservers.xml\" -o -name \"scheduledtasks.xml\" -o -name \"KeePass.config*\" -o -name \"anaconda-ks.cfg\" -o -name \"credentials.db\" -o -name \"pgadmin*.db\" -o -name \"gvm-tools.conf\" -o -name \"gitlab.yml\" -o -name \"error.log\" -o -name \"authorized_hosts\" -o -name \"ConsoleHost_history.txt\" -o -name \"protecteduserkey.bin\" -o -name \"docker.sock\" -o -name \"*password*\" -o -name \"accessTokens.json\" -o -name \"autologin\" -o -name \"*.crt\" -o -name \"storage.php\" -o -name \"legacy_credentials.db\" -o -name \"TokenCache.dat\" -o -name \".gitconfig\" -o -name \"pg_hba.conf\" -o -name \"*.ovpn\" -o -name \"db.php\" -o -name \"*.kdbx\" -o -name \"https.conf\" -o -name \"drives.xml\" -o -name \"index.dat\" -o -name \"RDCMan.settings\" -o -name \"supervisord.conf\" -o -name \"config.php\" -o -name \"hostapd.conf\" -o -name \".git-credentials\" -o -name \"appcmd.exe\" -o -name \"sess_*\" -o -name \"ws_ftp.ini\" -o -name \"web*.config\" -o -name \"000-default.conf\" -o -name \".bashrc\" -o -name \"php.ini\" -o -name \"SYSTEM\" -o -name \"rsyncd.conf\" -o -name \"scclient.exe\" -o -name \".lesshst\" -o -name \"creds*\" -o -name \".github\" -o -name \".sudo_as_admin_successful\" -o -name \"cloud.cfg\" -o -name \"datasources.xml\" -o -name \"AppEvent.Evt\" -o -name \".ldaprc\" -o -name \"my.ini\" -o -name \".plan\" -o -name \"sites.ini\" -o -name \"gitlab.rm\" -o -name \"*.sqlite3\" -o -name \"*.timer\" -o -name \"hosts.equiv\" -o -name \"Ntds.dit\" -o -name \"software\" -o -name \".rhosts\" -o -name \"kibana.y*ml\" -o -name \"ftp.ini\" -o -name \"sysprep.inf\" -o -name \"rsyncd.secrets\" -o -name \".k5login\" -o -name \"mosquitto.conf\" -o -name \"https-xampp.conf\" -o -name \"*.db\" -o -name \"snmpd.conf\" -o -name \"cesi.conf\" -o -name \"*.ftpconfig\" -o -name \"*.sqlite\" -o -name \"backup\" -o -name \".*_history.*\" -o -name \"SecEvent.Evt\" -o -name \"unattend.txt\" -o -name \"printers.xml\" -o -name \"mongod*.conf\" -o -name \"*.keystore\" -o -name \"unattend.xml\" -o -name \"krb5.conf\" -o -name \"groups.xml\" -o -name \"*.jks\" -o -name \"sysprep.xml\" -o -name \"*config*.php\" -o -name \"ipsec.secrets\" -o -name \"*.socket\" -o -name \"credentials\" -o -name \".vault-token\" -o -name \".profile\" -o -name \"postgresql.conf\" -o -name \".google_authenticator\" -o -name \"ntuser.dat\" -o -name \"pgsql.conf\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  PSTORAGE_SYSTEMD=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN"  | grep -E "^/lib32|^/cdrom|^/.cache|^/opt|^/srv|^/etc|^/systemd|^/system|^/private|^$GREPHOMESEARCH|^/mnt|^/lib64|^/var|^/snap|^/bin|^/lib|^/run|^/sbin|^/usr|^/sys|^/applications|^/media|^/tmp" | grep -E ".*\.service$" | sort | uniq | head -n 70)
  PSTORAGE_TIMER=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN"  | grep -E "^/lib32|^/cdrom|^/.cache|^/opt|^/srv|^/etc|^/systemd|^/system|^/private|^$GREPHOMESEARCH|^/mnt|^/lib64|^/var|^/snap|^/bin|^/lib|^/run|^/sbin|^/usr|^/sys|^/applications|^/media|^/tmp" | grep -E ".*\.timer$" | sort | uniq | head -n 70)
  PSTORAGE_SOCKET=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN"  | grep -E "^/lib32|^/cdrom|^/.cache|^/opt|^/srv|^/etc|^/systemd|^/system|^/private|^$GREPHOMESEARCH|^/mnt|^/lib64|^/var|^/snap|^/bin|^/lib|^/run|^/sbin|^/usr|^/sys|^/applications|^/media|^/tmp" | grep -E ".*\.socket$" | sort | uniq | head -n 70)
  PSTORAGE_DBUS=$(echo -e "$FIND_DIR_PRIVATE\n$FIND_DIR_MEDIA\n$FIND_DIR_SRV\n$FIND_DIR_SNAP\n$FIND_DIR_VAR\n$FIND_DIR_TMP\n$FIND_DIR_USR\n$FIND_DIR_CDROM\n$FIND_DIR_SBIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_BIN\n$FIND_DIR_MNT\n$FIND_DIR_ETC\n$FIND_DIR_CACHE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT"  | grep -E "^/etc" | grep -E "system\.d$" | sort | uniq | head -n 70)
  PSTORAGE_MYSQL=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN\n$FIND_DIR_PRIVATE\n$FIND_DIR_MEDIA\n$FIND_DIR_SRV\n$FIND_DIR_SNAP\n$FIND_DIR_VAR\n$FIND_DIR_TMP\n$FIND_DIR_USR\n$FIND_DIR_CDROM\n$FIND_DIR_SBIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_BIN\n$FIND_DIR_MNT\n$FIND_DIR_ETC\n$FIND_DIR_CACHE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT"  | grep -v -E 'mysql/mysql' | grep -E '^/etc/.*mysql|/usr/var/lib/.*mysql|/var/lib/.*mysql' | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E "mysql$|debian\.cnf$" | sort | uniq | head -n 70)
  PSTORAGE_POSTGRESQL=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN"  | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E "pgadmin.*\.db$|pg_hba\.conf$|postgresql\.conf$|pgsql\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_APACHE=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN\n$FIND_DIR_PRIVATE\n$FIND_DIR_MEDIA\n$FIND_DIR_SRV\n$FIND_DIR_SNAP\n$FIND_DIR_VAR\n$FIND_DIR_TMP\n$FIND_DIR_USR\n$FIND_DIR_CDROM\n$FIND_DIR_SBIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_BIN\n$FIND_DIR_MNT\n$FIND_DIR_ETC\n$FIND_DIR_CACHE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT"  | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E "sites-enabled$|000-default\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_PHP_SESSIONS=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN"  | grep -E '/tmp/.*sess_.*|/var/tmp/.*sess_.*' | grep -E "^/private|^/tmp|^/mnt|^/var" | grep -E "sess_.*$" | sort | uniq | head -n 70)
  PSTORAGE_PHP_FILES=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN"  | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E ".*config.*\.php$|database\.php$|db\.php$|storage\.php$|settings\.php$" | sort | uniq | head -n 70)
  PSTORAGE_WORDPRESS=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN"  | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E "wp-config\.php$" | sort | uniq | head -n 70)
  PSTORAGE_DRUPAL=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN"  | grep -E '/default/settings.php' | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E "settings\.php$" | sort | uniq | head -n 70)
  PSTORAGE_MOODLE=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN"  | grep -E 'moodle/config.php' | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E "config\.php$" | sort | uniq | head -n 70)
  PSTORAGE_TOMCAT=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN"  | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E "tomcat-users\.xml$" | sort | uniq | head -n 70)
  PSTORAGE_MONGO=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN"  | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E "mongod.*\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_SUPERVISORD=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN"  | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E "supervisord\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_CESI=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN"  | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E "cesi\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_RSYNC=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN"  | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E "rsyncd\.conf$|rsyncd\.secrets$" | sort | uniq | head -n 70)
  PSTORAGE_HOSTAPD=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN"  | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E "hostapd\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_ANACONDA_KS=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN"  | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E "anaconda-ks\.cfg$" | sort | uniq | head -n 70)
  PSTORAGE_VNC=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN\n$FIND_DIR_PRIVATE\n$FIND_DIR_MEDIA\n$FIND_DIR_SRV\n$FIND_DIR_SNAP\n$FIND_DIR_VAR\n$FIND_DIR_TMP\n$FIND_DIR_USR\n$FIND_DIR_CDROM\n$FIND_DIR_SBIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_BIN\n$FIND_DIR_MNT\n$FIND_DIR_ETC\n$FIND_DIR_CACHE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT"  | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E "\.vnc$|.*vnc.*\.c.*nf.*$|.*vnc.*\.ini$|.*vnc.*\.txt$|.*vnc.*\.xml$" | sort | uniq | head -n 70)
  PSTORAGE_LDAP=$(echo -e "$FIND_DIR_PRIVATE\n$FIND_DIR_MEDIA\n$FIND_DIR_SRV\n$FIND_DIR_SNAP\n$FIND_DIR_VAR\n$FIND_DIR_TMP\n$FIND_DIR_USR\n$FIND_DIR_CDROM\n$FIND_DIR_SBIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_BIN\n$FIND_DIR_MNT\n$FIND_DIR_ETC\n$FIND_DIR_CACHE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT"  | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E "ldap$" | sort | uniq | head -n 70)
  PSTORAGE_OPENVPN=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN"  | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E ".*\.ovpn$" | sort | uniq | head -n 70)
  PSTORAGE_SSH=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN"  | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E "id_dsa.*$|id_rsa.*$|known_hosts$|authorized_hosts$|authorized_keys$" | sort | uniq | head -n 70)
  PSTORAGE_CERTSB4=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN"  | grep -v -E '^/usr/share/|^/etc/ssl/|^/usr/local/lib/|^/usr/lib.*' | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E ".*\.pem$|.*\.cer$|.*\.crt$" | sort | uniq | head -n 70)
  PSTORAGE_CERTSBIN=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN"  | grep -v -E '^/usr/share/|^/etc/ssl/|^/usr/local/lib/|^/usr/lib/.*' | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E ".*\.csr$|.*\.der$" | sort | uniq | head -n 70)
  PSTORAGE_CERTSCLIENT=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN"  | grep -v -E '^/usr/share/|^/etc/ssl/|^/usr/local/lib/|^/usr/lib/.*' | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E ".*\.pfx$|.*\.p12$" | sort | uniq | head -n 70)
  PSTORAGE_SSH_AGENTS=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN"  | grep -E "^/private|^/tmp" | grep -E "agent.*$" | sort | uniq | head -n 70)
  PSTORAGE_SSH_CONFIG=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN"  | grep -E "^/usr|^$GREPHOMESEARCH" | grep -E "ssh.*config$" | sort | uniq | head -n 70)
  PSTORAGE_CLOUD_CREDENTIALS=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN\n$FIND_DIR_PRIVATE\n$FIND_DIR_MEDIA\n$FIND_DIR_SRV\n$FIND_DIR_SNAP\n$FIND_DIR_VAR\n$FIND_DIR_TMP\n$FIND_DIR_USR\n$FIND_DIR_CDROM\n$FIND_DIR_SBIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_BIN\n$FIND_DIR_MNT\n$FIND_DIR_ETC\n$FIND_DIR_CACHE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT"  | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E "credentials$|credentials\.db$|legacy_credentials\.db$|access_tokens\.db$|access_tokens\.json$|accessTokens\.json$|azureProfile\.json$|TokenCache\.dat$|AzureRMContext\.json$|\.bluemix$" | sort | uniq | head -n 70)
  PSTORAGE_KERBEROS=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN"  | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E "krb5\.conf$|krb5\.keytab$|\.k5login$|kadm5\.acl$" | sort | uniq | head -n 70)
  PSTORAGE_KIBANA=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN"  | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E "kibana\.y.*ml$" | sort | uniq | head -n 70)
  PSTORAGE_KNOCKD=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN"  | grep -E '/etc/init.d/' | grep -E "^/etc" | grep -E ".*knockd.*$" | sort | uniq | head -n 70)
  PSTORAGE_LOGSTASH=$(echo -e "$FIND_DIR_PRIVATE\n$FIND_DIR_MEDIA\n$FIND_DIR_SRV\n$FIND_DIR_SNAP\n$FIND_DIR_VAR\n$FIND_DIR_TMP\n$FIND_DIR_USR\n$FIND_DIR_CDROM\n$FIND_DIR_SBIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_BIN\n$FIND_DIR_MNT\n$FIND_DIR_ETC\n$FIND_DIR_CACHE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT"  | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E "logstash$" | sort | uniq | head -n 70)
  PSTORAGE_ELASTICSEARCH=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN"  | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E "elasticsearch\.y.*ml$" | sort | uniq | head -n 70)
  PSTORAGE_VAULT_SSH_HELPER=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN"  | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E "vault-ssh-helper\.hcl$" | sort | uniq | head -n 70)
  PSTORAGE_VAULT_SSH_TOKEN=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN"  | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E "\.vault-token$" | sort | uniq | head -n 70)
  PSTORAGE_COUCHDB=$(echo -e "$FIND_DIR_PRIVATE\n$FIND_DIR_MEDIA\n$FIND_DIR_SRV\n$FIND_DIR_SNAP\n$FIND_DIR_VAR\n$FIND_DIR_TMP\n$FIND_DIR_USR\n$FIND_DIR_CDROM\n$FIND_DIR_SBIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_BIN\n$FIND_DIR_MNT\n$FIND_DIR_ETC\n$FIND_DIR_CACHE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT"  | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E "couchdb$" | sort | uniq | head -n 70)
  PSTORAGE_REDIS=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN"  | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E "redis\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_MOSQUITTO=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN"  | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E "mosquitto\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_NEO4J=$(echo -e "$FIND_DIR_PRIVATE\n$FIND_DIR_MEDIA\n$FIND_DIR_SRV\n$FIND_DIR_SNAP\n$FIND_DIR_VAR\n$FIND_DIR_TMP\n$FIND_DIR_USR\n$FIND_DIR_CDROM\n$FIND_DIR_SBIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_BIN\n$FIND_DIR_MNT\n$FIND_DIR_ETC\n$FIND_DIR_CACHE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT"  | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E "neo4j$" | sort | uniq | head -n 70)
  PSTORAGE_CLOUD_INIT=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN"  | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E "cloud\.cfg$" | sort | uniq | head -n 70)
  PSTORAGE_ERLANG=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN"  | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E "\.erlang\.cookie$" | sort | uniq | head -n 70)
  PSTORAGE_GMV_AUTH=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN"  | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E "gvm-tools\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_IPSEC=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN"  | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E "ipsec\.secrets$|ipsec\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_IRSSI=$(echo -e "$FIND_DIR_PRIVATE\n$FIND_DIR_MEDIA\n$FIND_DIR_SRV\n$FIND_DIR_SNAP\n$FIND_DIR_VAR\n$FIND_DIR_TMP\n$FIND_DIR_USR\n$FIND_DIR_CDROM\n$FIND_DIR_SBIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_BIN\n$FIND_DIR_MNT\n$FIND_DIR_ETC\n$FIND_DIR_CACHE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT"  | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E "\.irssi$" | sort | uniq | head -n 70)
  PSTORAGE_KEYRING=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN\n$FIND_DIR_PRIVATE\n$FIND_DIR_MEDIA\n$FIND_DIR_SRV\n$FIND_DIR_SNAP\n$FIND_DIR_VAR\n$FIND_DIR_TMP\n$FIND_DIR_USR\n$FIND_DIR_CDROM\n$FIND_DIR_SBIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_BIN\n$FIND_DIR_MNT\n$FIND_DIR_ETC\n$FIND_DIR_CACHE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT"  | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E "keyrings$|.*\.keyring$|.*\.keystore$|.*\.jks$" | sort | uniq | head -n 70)
  PSTORAGE_FILEZILLA=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN\n$FIND_DIR_PRIVATE\n$FIND_DIR_MEDIA\n$FIND_DIR_SRV\n$FIND_DIR_SNAP\n$FIND_DIR_VAR\n$FIND_DIR_TMP\n$FIND_DIR_USR\n$FIND_DIR_CDROM\n$FIND_DIR_SBIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_BIN\n$FIND_DIR_MNT\n$FIND_DIR_ETC\n$FIND_DIR_CACHE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT"  | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E "filezilla$|filezilla\.xml$|recentservers\.xml$" | sort | uniq | head -n 70)
  PSTORAGE_BACKUP_MANAGER=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN"  | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E "storage\.php$|database\.php$" | sort | uniq | head -n 70)
  PSTORAGE_SPLUNK=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN"  | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E "passwd$" | sort | uniq | head -n 70)
  PSTORAGE_GITLAB=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN"  | grep -v -E '/lib' | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E "secrets\.yml$|gitlab\.yml$|gitlab\.rm$" | sort | uniq | head -n 70)
  PSTORAGE_PGP_GPG=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN"  | grep -v -E 'README.gnupg' | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E ".*\.pgp$|.*\.gpg$|.*\.gnupg$" | sort | uniq | head -n 70)
  PSTORAGE_CACHE_VI=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN"  | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E ".*\.swp$|.*\.viminfo$" | sort | uniq | head -n 70)
  PSTORAGE_DOCKER=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN"  | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E "docker\.socket$|docker\.sock$|Dockerfile$|docker-compose\.yml$" | sort | uniq | head -n 70)
  ...
  PSTORAGE_AUTOLOGIN=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN"  | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E "autologin$|autologin\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_FASTCGI=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN"  | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E "fastcgi_params$" | sort | uniq | head -n 70)
  PSTORAGE_SNMP=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN"  | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E "snmpd\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_PYPIRC=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN"  | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E "\.pypirc$" | sort | uniq | head -n 70)
  PSTORAGE_CLOUDFLARE=$(echo -e "$FIND_DIR_PRIVATE\n$FIND_DIR_MEDIA\n$FIND_DIR_SRV\n$FIND_DIR_SNAP\n$FIND_DIR_VAR\n$FIND_DIR_TMP\n$FIND_DIR_USR\n$FIND_DIR_CDROM\n$FIND_DIR_SBIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_BIN\n$FIND_DIR_MNT\n$FIND_DIR_ETC\n$FIND_DIR_CACHE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT"  | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E "\.cloudflared$" | sort | uniq | head -n 70)
  PSTORAGE_HISTORY=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN"  | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E "\..*_history\..*$" | sort | uniq | head -n 70)
  PSTORAGE_HTTP_CONF=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN"  | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E "httpd\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_HTPASSWD=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN"  | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E "\.htpasswd$" | sort | uniq | head -n 70)
  PSTORAGE_LDAPRC=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN"  | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E "\.ldaprc$" | sort | uniq | head -n 70)
  PSTORAGE_ENV=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN"  | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E "\.env$" | sort | uniq | head -n 70)
  PSTORAGE_MSMTPRC=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN"  | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E "\.msmtprc$" | sort | uniq | head -n 70)
  PSTORAGE_GITHUB=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN"  | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E "\.github$|\.gitconfig$|\.git-credentials$|\.git$" | sort | uniq | head -n 70)
  PSTORAGE_SVN=$(echo -e "$FIND_DIR_PRIVATE\n$FIND_DIR_MEDIA\n$FIND_DIR_SRV\n$FIND_DIR_SNAP\n$FIND_DIR_VAR\n$FIND_DIR_TMP\n$FIND_DIR_USR\n$FIND_DIR_CDROM\n$FIND_DIR_SBIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_BIN\n$FIND_DIR_MNT\n$FIND_DIR_ETC\n$FIND_DIR_CACHE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT"  | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E "\.svn$" | sort | uniq | head -n 70)
  PSTORAGE_KEEPASS=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN"  | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E ".*\.kdbx$|KeePass\.config.*$|KeePass\.ini$|KeePass\.enforced.*$" | sort | uniq | head -n 70)
  PSTORAGE_FTP=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN"  | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E ".*\.ftpconfig$|ffftp\.ini$|ftp\.ini$|ftp\.config$|sites\.ini$|wcx_ftp\.ini$|winscp\.ini$|ws_ftp\.ini$" | sort | uniq | head -n 70)
  PSTORAGE_BIND=$(echo -e "$FIND_DIR_PRIVATE\n$FIND_DIR_MEDIA\n$FIND_DIR_SRV\n$FIND_DIR_SNAP\n$FIND_DIR_VAR\n$FIND_DIR_TMP\n$FIND_DIR_USR\n$FIND_DIR_CDROM\n$FIND_DIR_SBIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_BIN\n$FIND_DIR_MNT\n$FIND_DIR_ETC\n$FIND_DIR_CACHE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT"  | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E "bind$" | sort | uniq | head -n 70)
  PSTORAGE_SEEDDMS=$(echo -e "$FIND_DIR_PRIVATE\n$FIND_DIR_MEDIA\n$FIND_DIR_SRV\n$FIND_DIR_SNAP\n$FIND_DIR_VAR\n$FIND_DIR_TMP\n$FIND_DIR_USR\n$FIND_DIR_CDROM\n$FIND_DIR_SBIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_BIN\n$FIND_DIR_MNT\n$FIND_DIR_ETC\n$FIND_DIR_CACHE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT"  | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E "seeddms.*$" | sort | uniq | head -n 70)
  PSTORAGE_DDCLIENT=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN"  | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E "ddclient\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_KCPASSWORD=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN"  | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E "kcpassword$" | sort | uniq | head -n 70)
  PSTORAGE_CACTI=$(echo -e "$FIND_DIR_PRIVATE\n$FIND_DIR_MEDIA\n$FIND_DIR_SRV\n$FIND_DIR_SNAP\n$FIND_DIR_VAR\n$FIND_DIR_TMP\n$FIND_DIR_USR\n$FIND_DIR_CDROM\n$FIND_DIR_SBIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_BIN\n$FIND_DIR_MNT\n$FIND_DIR_ETC\n$FIND_DIR_CACHE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT"  | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E "cacti$" | sort | uniq | head -n 70)
  PSTORAGE_INTERESTING_LOGS=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN"  | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E "access\.log$|error\.log$" | sort | uniq | head -n 70)
  PSTORAGE_OTHER_INTERESTING_FILES=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN"  | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E "\.bashrc$|\.google_authenticator$|hosts\.equiv$|\.lesshst$|\.plan$|\.profile$|\.recently-used\.xbel$|\.rhosts$|\.sudo_as_admin_successful$" | sort | uniq | head -n 70)
  PSTORAGE_WINDOWS_FILES=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN"  | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E "unattend\.inf$|.*\.rdg$|AppEvent\.Evt$|ConsoleHost_history\.txt$|FreeSSHDservice\.ini$|NetSetup\.log$|Ntds\.dit$|protecteduserkey\.bin$|RDCMan\.settings$|SAM$|SYSTEM$|SecEvent\.Evt$|appcmd\.exe$|bash\.exe$|datasources\.xml$|default\.sav$|drives\.xml$|groups\.xml$|https-xampp\.conf$|https\.conf$|iis6\.log$|index\.dat$|my\.cnf$|my\.ini$|ntuser\.dat$|pagefile\.sys$|php\.ini$|printers\.xml$|recentservers\.xml$|scclient\.exe$|scheduledtasks\.xml$|security\.sav$|server\.xml$|setupinfo$|setupinfo\.bak$|sitemanager\.xml$|sites\.ini$|software$|software\.sav$|sysprep\.inf$|sysprep\.xml$|system\.sav$|unattend\.txt$|unattend\.xml$|unattended\.xml$|wcx_ftp\.ini$|ws_ftp\.ini$|web.*\.config$|winscp\.ini$|wsl\.exe$" | sort | uniq | head -n 70)
  PSTORAGE_DATABASE=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN"  | grep -v -E '/man/|/usr/|/var/cache/' | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E ".*\.db$|.*\.sqlite$|.*\.sqlite3$" | sort | uniq | head -n 70)
  PSTORAGE_BACKUPS=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN"  | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E "backup$|backups$" | sort | uniq | head -n 70)
  PSTORAGE_PASSWORD_FILES=$(echo -e "$FIND_MNT\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_SBIN\n$FIND_LIB32\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_USR\n$FIND_VAR\n$FIND_PRIVATE\n$FIND_OPT\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_CDROM\n$FIND_ETC\n$FIND_BIN"  | grep -E "^/usr|^/cdrom|^/.cache|^/snap|^/opt|^/srv|^/applications|^$GREPHOMESEARCH|^/media|^/private|^/bin|^/etc|^/mnt|^/sbin|^/tmp|^/var" | grep -E ".*password.*$|.*credential.*$|creds.*$|.*\.key$" | sort | uniq | head -n 70)
